import {
  core_exports
} from "./chunk-MSGT62YE.js";
import {
  shared_exports,
  vue_demi_exports
} from "./chunk-JM7EZ57A.js";
import {
  defu
} from "./chunk-TYANDH6Q.js";
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/utils.mjs
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/numbers/index.mjs
var number = {
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/numbers/units.mjs
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/color/utils.mjs
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/color/hsla.mjs
var hsla = {
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/color/rgba.mjs
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/color/hex.mjs
function parseHex(v) {
  let r = "";
  let g = "";
  let b2 = "";
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/color/index.mjs
var color = {
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/complex/index.mjs
var colorToken = "${c}";
var numberToken = "${n}";
function test(v) {
  var _a, _b, _c, _d;
...
// node_modules/popmotion/node_modules/style-value-types/dist/es/complex/filter.mjs
...
var sanitize2 = (v) => v % 1 ? Number(v.toFixed(5)) : v;
...
var alpha2 = Object.assign(Object.assign({}, number2), { transform: clamp3(0, 1) });
var scale2 = Object.assign(Object.assign({}, number2), { default: 1 });
...
var progressPercentage2 = Object.assign(Object.assign({}, percent2), { parse: (v) => percent2.parse(v) / 100, transform: (v) => percent2.transform(v * 100) });

// node_modules/style-value-types/dist/es/color/utils.mjs
var isColorString2 = (type, testProp) => (v) => {
  return Boolean(isString2(v) && singleColorRegex2.test(v) && v.startsWith(type) || testProp && Object.prototype.hasOwnProperty.call(v, testProp));
};
var splitColor2 = (aName, bName, cName) => (v) => {
  if (!isString2(v))
    return v;
  const [a2, b2, c2, alpha3] = v.match(floatRegex2);
  return {
    [aName]: parseFloat(a2),
    [bName]: parseFloat(b2),
    [cName]: parseFloat(c2),
...
var clampRgbUnit2 = clamp3(0, 255);
var rgbUnit2 = Object.assign(Object.assign({}, number2), { transform: (v) => Math.round(clampRgbUnit2(v)) });
var rgba2 = {
...
function test2(v) {
  var _a, _b, _c, _d;
  return isNaN(v) && isString2(v) && ((_b = (_a = v.match(floatRegex2)) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) + ((_d = (_c = v.match(colorRegex2)) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0) > 0;
}
function analyse3(v) {
  if (typeof v === "number")
    v = `${v}`;
...
function createTransformer2(v) {
  const { values, numColors, tokenised } = analyse3(v);
  const numValues = values.length;
  return (v2) => {
    let output = tokenised;
    for (let i = 0; i < numValues; i++) {
...
function getAnimatableNone2(v) {
  const parsed = parse2(v);
  const transformer = createTransformer2(v);
  return transformer(parsed.map(convertNumbersToZero2));
}
var complex2 = { test: test2, parse: parse2, createTransformer: createTransformer2, getAnimatableNone: getAnimatableNone2 };
...
var filter2 = Object.assign(Object.assign({}, complex2), { getAnimatableNone: (v) => {
...
function useMotionValues() {
  const motionValues = (0, vue_demi_exports.ref)({});
  const stop = (keys) => {
    const destroyKey = (key) => {
      ...
      (0, vue_demi_exports.del)(motionValues.value, key);
    };
    if (keys) {
      if (isArray(keys)) {
  ...
  const get = (key, from, target) => {
    ...
    motionValue.onChange((v) => {
      (0, vue_demi_exports.set)(target, key, v);
    });
    (0, vue_demi_exports.set)(motionValues.value, key, motionValue);
    return motionValue;
  };
  (0, shared_exports.tryOnUnmounted)(stop);
  return {
    motionValues,
    get,
    stop
...
function useMotionControls(motionProperties, variants = {}, { motionValues, push, stop } = useMotionTransitions()) {
  const _variants = (0, vue_demi_exports.unref)(variants);
  const isAnimating = (0, vue_demi_exports.ref)(false);
  const _stopWatchAnimating = (0, vue_demi_exports.watch)(motionValues, (newVal) => {
  ...
  const set2 = (variant) => {
    const variantData = (0, core_exports.isObject)(variant) ? variant : getVariantFromKey(variant);
...
function registerEventListeners({
  ...
  const _useEventListener = (...args) => {
    const _stop = core_exports.useEventListener.apply(null, args);
    _eventListeners.push(_stop);
    return _stop;
  };
  const hovered = (0, vue_demi_exports.ref)(false);
  const tapped = (0, vue_demi_exports.ref)(false);
  const focused = (0, vue_demi_exports.ref)(false);
  const mutableKeys = (0, vue_demi_exports.computed)(() => {
    let result = [];
    if (!_variants)
      return result;
  ...
  const computedProperties = (0, vue_demi_exports.computed)(() => {
    const result = {};
  ...
  const _stopSync = (0, vue_demi_exports.watch)(computedProperties, apply);
  const stop = () => {
...
function registerVariantsSync({
  ...
  const stop = (0, vue_demi_exports.watch)(state, (newVal) => {
    if (newVal)
      apply(newVal);
  }, {
    immediate: true
...
function registerVisibilityHooks({
  ...
  const _variants = (0, vue_demi_exports.unref)(variants);
  let stop = core_exports.noop;
  if (_variants && (_variants.visible || _variants.visibleOnce)) {
    const { stop: stopObserver } = (0, core_exports.useIntersectionObserver)(target, ([{ isIntersecting }]) => {
...
function useMotionFeatures(instance, options = {
  ...
  const toStop = (0, vue_demi_exports.ref)([]);
  ...
  (0, core_exports.tryOnUnmounted)(stop);
  return { stop };
}
function reactiveStyle(props = {}) {
  ...
  const style = (0, vue_demi_exports.ref)({});
  (0, vue_demi_exports.watch)(state, () => {
    const result = {};
...
function useElementStyle(target, onInit) {
  ...
  const stopInitWatch = (0, vue_demi_exports.watch)(() => (0, core_exports.unrefElement)(target), (el) => {
    if (!el)
      return;
    _target = el;
    for (const key of Object.keys(valueTypes)) {
      if (el.style[key] === null || el.style[key] === "" || isTransformProp(key) || isTransformOriginProp(key))
        continue;
      (0, vue_demi_exports.set)(state, key, el.style[key]);
    }
    if (_cache) {
      Object.entries(_cache).forEach(([key, value]) => (0, vue_demi_exports.set)(el.style, key, value));
    }
    if (onInit)
      onInit(state);
  }, {
  ...
  const stopSyncWatch = (0, vue_demi_exports.watch)(style, (newVal) => {
    if (!_target) {
      _cache = newVal;
      return;
    }
    for (const key in newVal)
      (0, vue_demi_exports.set)(_target.style, key, newVal[key]);
  }, {
    immediate: true
  });
  const stop = () => {
...
function reactiveTransform(props = {}, enableHardwareAcceleration = true) {
  const state = (0, vue_demi_exports.reactive)({ ...props });
  const transform = (0, vue_demi_exports.ref)("");
  (0, vue_demi_exports.watch)(state, (newVal) => {
    let result = "";
...
function stateFromTransform(state, transform) {
  Object.entries(parseTransform(transform)).forEach(([key, value]) => {
    ...
    if (key === "translate3d") {
      if (value === 0) {
        axes.forEach((axis) => {
          (0, vue_demi_exports.set)(state, axis, 0);
        });
        return;
      }
      value.forEach((axisValue, index) => {
        (0, vue_demi_exports.set)(state, axes[index], axisValue);
      });
      return;
    }
    if (key === "translateX") {
      (0, vue_demi_exports.set)(state, "x", value);
      return;
    }
    if (key === "translateY") {
      (0, vue_demi_exports.set)(state, "y", value);
      return;
    }
    if (key === "translateZ") {
      (0, vue_demi_exports.set)(state, "z", value);
      return;
    }
    (0, vue_demi_exports.set)(state, key, value);
  });
}
function useElementTransform(target, onInit) {
  ...
  const stopSyncWatch = (0, vue_demi_exports.watch)(transform, (newValue) => {
    if (!_target) {
      _cache = newValue;
      return;
    }
...
function useMotionProperties(target, defaultValues) {
  const motionProperties = (0, vue_demi_exports.reactive)({});
  const apply = (values) => {
    Object.entries(values).forEach(([key, value]) => {
      (0, vue_demi_exports.set)(motionProperties, key, value);
    });
  };
  ...
  const stopPropertiesWatch = (0, vue_demi_exports.watch)(motionProperties, (newVal) => {
    Object.entries(newVal).forEach(([key, value]) => {
      const target2 = isTransformProp(key) ? transform : style;
      if (target2[key] && target2[key] === value)
        return;
      (0, vue_demi_exports.set)(target2, key, value);
    });
  }, {
    immediate: true,
    deep: true
...
function useMotionVariants(variants = {}) {
  const _variants = (0, vue_demi_exports.unref)(variants);
  const variant = (0, vue_demi_exports.ref)();
  const state = (0, vue_demi_exports.computed)(() => {
    if (!variant.value)
      return;
...
function useMotion(target, variants = {}, options) {
  ...
  instance.stop = (force = false) => {
    ...
    if (!force && variants.value && variants.value.leave) {
      const _stopWatch = (0, vue_demi_exports.watch)(instance.isAnimating, (newVal) => {
        if (!newVal) {
          _stopWatch();
          _stop();
        }
  ...
  (0, core_exports.tryOnUnmounted)(() => instance.stop());
  (0, core_exports.watchOnce)(() => (0, core_exports.unrefElement)(target), (el) => {
    if (!el)
      return;
    if (el == null ? void 0 : el.motionInstance) {
      instance.stop();
...
var resolveVariants = (node, variantsRef) => {
  ...
  if (target) {
    if (target.variants && (0, core_exports.isObject)(target.variants)) {
      variantsRef.value = {
        ...variantsRef.value,
        ...target.variants
      };
    ...
    directivePropsKeys.forEach((key) => {
      if (key === "delay") {
        if (target && target[key] && (0, core_exports.isNumber)(target[key])) {
      ...
      if (key === "visible-once")
        key = "visibleOnce";
      if (target && target[key] && (0, core_exports.isObject)(target[key]))
...
var directive = (variants) => {
  const register = (el, binding, node) => {
    ...
    const variantsRef = (0, vue_demi_exports.ref)(variants || {});
    ...
    if (key)
      (0, vue_demi_exports.set)(motionState, key, motionInstance);
  };
  const unregister = (el) => {
...
function isMotionInstance(obj) {
  const _obj = obj;
  return _obj.apply !== void 0 && (0, shared_exports.isFunction)(_obj.apply) && _obj.set !== void 0 && (0, shared_exports.isFunction)(_obj.set) && _obj.stopTransitions !== void 0 && (0, shared_exports.isFunction)(_obj.stopTransitions) && _obj.target !== void 0 && (0, vue_demi_exports.isRef)(_obj.target);
}
function useReducedMotion(options = {}) {
  return (0, core_exports.useMediaQuery)("(prefers-reduced-motion: reduce)", options);
}
export {
