...
var X = T(($D, Vr) => {
  ...
  Vr.exports = Oe(typeof globalThis == "object" && globalThis) || Oe(typeof window == "object" && window) || Oe(typeof self == "object" && self) || Oe(typeof global == "object" && global) || function() {
    return this;
...
var le = T((XD, Wr) => {
  var Fs = qe(), Ie = Function.prototype.call;
...
var Jr = T((Kr) => {
  "use strict";
  var Yr = {}.propertyIsEnumerable, Qr = Object.getOwnPropertyDescriptor, As = Qr && !Yr.call({ 1: 2 }, 1);
  Kr.f = As ? function(r) {
    var t = Qr(this, r);
...
var te = T((WD, tt) => {
  var et = qe(), rt = Function.prototype, vs = rt.bind, rr = rt.call, _s = et && vs.bind(rr, rr);
  tt.exports = et ? function(e) {
    return e && _s(e);
  } : function(e) {
    return e && function() {
...
var xe = T((YD, nt) => {
  var ut = te(), Ss = ut({}.toString), ys = ut("".slice);
  nt.exports = function(e) {
    return ys(Ss(e), 8, -1);
  };
});
var at = T((QD, st) => {
  var Ts = X(), Bs = te(), bs = ae(), ws = xe(), tr = Ts.Object, Ns = Bs("".split);
...
var ur = T((KD, it) => {
  var Os = X(), qs = Os.TypeError;
  it.exports = function(e) {
    if (e == null)
      throw qs("Can't call method on " + e);
    return e;
  };
});
var Pe = T((JD, ot) => {
...
var At = T((nl, Ft) => {
  var gt = X(), ar = ft(), dt = gt.process, Et = gt.Deno, Ct = dt && dt.versions || Et && Et.version, mt = Ct && Ct.v8, ne, ke;
  mt && (ne = mt.split("."), ke = ne[0] > 0 && ne[0] < 4 ? 1 : +(ne[0] + ne[1]));
  !ke && ar && (ne = ar.match(/Edge\/(\d+)/), (!ne || ne[1] >= 74) && (ne = ar.match(/Chrome\/(\d+)/), ne && (ke = +ne[1])));
  Ft.exports = ke;
});
var ir = T((sl, _t) => {
  var vt = At(), js = ae();
  _t.exports = !!Object.getOwnPropertySymbols && !js(function() {
    var e = Symbol();
    return !String(e) || !(Object(e) instanceof Symbol) || !Symbol.sham && vt && vt < 41;
  });
});
var or = T((al, St) => {
  var $s = ir();
...
var cr = T((il, yt) => {
  var Us = X(), Gs = ve(), Vs = ue(), Xs = sr(), Hs = or(), zs = Us.Object;
  yt.exports = Hs ? function(e) {
...
var _e = T((cl, Bt) => {
  var Qs = X(), Ks = ue(), Js = Le(), Zs = Qs.TypeError;
...
var Nt = T((ll, wt) => {
  var ra = X(), Dr = le(), lr = ue(), hr = he(), ta = ra.TypeError;
  wt.exports = function(e, r) {
    var t, s;
    if (r === "string" && lr(t = e.toString) && !hr(s = Dr(t, e)) || lr(t = e.valueOf) && !hr(s = Dr(t, e)) || r !== "string" && lr(t = e.toString) && !hr(s = Dr(t, e)))
      return s;
...
var je = T((pl, Rt) => {
  var It = X(), ua = Object.defineProperty;
  Rt.exports = function(e, r) {
    try {
      ua(It, e, { value: r, configurable: true, writable: true });
    } catch {
      It[e] = r;
    }
    return r;
...
var $e = T((fl, Pt) => {
  var na = X(), sa = je(), xt = "__core-js_shared__", aa = na[xt] || sa(xt, {});
  Pt.exports = aa;
});
var pr = T((dl, Lt) => {
  var ia = qt(), kt = $e();
  ...
  })("versions", []).push({ version: "3.22.2", mode: ia ? "pure" : "global", copyright: "\xA9 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var fr = T((El, Mt) => {
  var oa = X(), ca = ur(), Da = oa.Object;
  Mt.exports = function(e) {
    return Da(ca(e));
  };
});
var oe = T((Cl, jt) => {
  var la = te(), ha = fr(), pa = la({}.hasOwnProperty);
  jt.exports = Object.hasOwn || function(r, t) {
    return pa(ha(r), t);
  };
});
var dr = T((ml, $t) => {
  var fa = te(), da = 0, Ea = Math.random(), Ca = fa(1 .toString);
  $t.exports = function(e) {
    return "Symbol(" + (e === void 0 ? "" : e) + ")_" + Ca(++da + Ea, 36);
  };
});
var fe = T((gl, Ht) => {
  var ma = X(), ga = pr(), Ut = oe(), Fa = dr(), Gt = ir(), Xt = or(), Ce = ga("wks"), pe = ma.Symbol, Vt = pe && pe.for, Aa = Xt ? pe : pe && pe.withoutSetter || Fa;
  Ht.exports = function(e) {
    if (!Ut(Ce, e) || !(Gt || typeof Ce[e] == "string")) {
      var r = "Symbol." + e;
      Gt && Ut(pe, e) ? Ce[e] = pe[e] : Xt && Vt ? Ce[e] = Vt(r) : Ce[e] = Aa(r);
    }
    return Ce[e];
  };
});
var Qt = T((Fl, Yt) => {
  var va = X(), _a = le(), zt = he(), Wt = cr(), Sa = Me(), ya = Nt(), Ta = fe(), Ba = va.TypeError, ba = Ta("toPrimitive");
...
var eu = T((vl, Zt) => {
  var Oa = X(), Jt = he(), Er = Oa.document, qa = Jt(Er) && Jt(Er.createElement);
  Zt.exports = function(e) {
    return qa ? Er.createElement(e) : {};
  };
});
var Cr = T((_l, ru) => {
  var Ia = De(), Ra = ae(), xa = eu();
  ru.exports = !Ia && !Ra(function() {
...
var mr = T((uu) => {
  var Pa = De(), ka = le(), La = Jr(), Ma = Re(), ja = Pe(), $a = Ue(), Ua = oe(), Ga = Cr(), tu = Object.getOwnPropertyDescriptor;
  uu.f = Pa ? tu : function(r, t) {
    if (r = ja(r), t = $a(t), Ga)
      try {
        return tu(r, t);
      } catch {
    ...
    if (Ua(r, t))
      return Ma(!ka(La.f, r, t), r[t]);
  };
});
var su = T((yl, nu) => {
  var Va = De(), Xa = ae();
  nu.exports = Va && Xa(function() {
    return Object.defineProperty(function() {
    }, "prototype", { value: 42, writable: false }).prototype != 42;
  });
});
var me = T((Tl, iu) => {
  var au = X(), Ha = he(), za = au.String, Wa = au.TypeError;
...
var Ve = T((cu) => {
  var Ya = X(), Qa = De(), Ka = Cr(), Ja = su(), Ge = me(), ou = Ue(), Za = Ya.TypeError, gr = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, Fr = "enumerable", Ar = "configurable", vr = "writable";
  cu.f = Qa ? Ja ? function(r, t, s) {
    if (Ge(r), t = ou(t), Ge(s), typeof r == "function" && t === "prototype" && "value" in s && vr in s && !s[vr]) {
      var c = ei(r, t);
      c && c[vr] && (r[t] = s.value, s = { configurable: Ar in s ? s[Ar] : c[Ar], enumerable: Fr in s ? s[Fr] : c[Fr], writable: false });
    }
    return gr(r, t, s);
  } : gr : function(r, t, s) {
    ...
    if ("get" in s || "set" in s)
      throw Za("Accessors not supported");
    return "value" in s && (r[t] = s.value), r;
  };
});
var Xe = T((bl, Du) => {
  var ri = De(), ti = Ve(), ui = Re();
...
var He = T((wl, lu) => {
  var ni = te(), si = ue(), _r = $e(), ai = ni(Function.toString);
  si(_r.inspectSource) || (_r.inspectSource = function(e) {
    return ai(e);
  });
  lu.exports = _r.inspectSource;
});
var fu = T((Nl, pu) => {
  var ii = X(), oi = ue(), ci = He(), hu = ii.WeakMap;
  pu.exports = oi(hu) && /native code/.test(ci(hu));
});
var Cu = T((Ol, Eu) => {
  var Di = pr(), li = dr(), du = Di("keys");
...
var Su = T((Il, _u) => {
  var hi = fu(), vu = X(), yr = te(), pi = he(), fi = Xe(), Tr = oe(), Br = $e(), di = Cu(), Ei = Sr(), gu = "Object already initialized", wr = vu.TypeError, Ci = vu.WeakMap, ze, Se, We, mi = function(e) {
  ...
  hi || Br.state ? (ce = Br.state || (Br.state = new Ci()), Fu = yr(ce.get), br = yr(ce.has), Au = yr(ce.set), ze = function(e, r) {
    if (br(ce, e))
      throw new wr(gu);
    ...
    return br(ce, e);
  }) : (de = di("state"), Ei[de] = true, ze = function(e, r) {
    if (Tr(e, de))
      throw new wr(gu);
...
var Bu = T((Rl, Tu) => {
  var Nr = De(), Fi = oe(), yu = Function.prototype, Ai = Nr && Object.getOwnPropertyDescriptor, Or = Fi(yu, "name"), vi = Or && function() {
  }.name === "something", _i = Or && (!Nr || Nr && Ai(yu, "name").configurable);
  Tu.exports = { EXISTS: Or, PROPER: vi, CONFIGURABLE: _i };
});
var qu = T((xl, Ou) => {
  var Si = X(), bu = ue(), yi = oe(), wu = Xe(), Ti = je(), Bi = He(), Nu = Su(), bi = Bu().CONFIGURABLE, wi = Nu.get, Ni = Nu.enforce, Oi = String(String).split("String");
  (Ou.exports = function(e, r, t, s) {
    var c = s ? !!s.unsafe : false, n = s ? !!s.enumerable : false, a = s ? !!s.noTargetGet : false, f = s && s.name !== void 0 ? s.name : r, D;
    if (bu(t) && (String(f).slice(0, 7) === "Symbol(" && (f = "[" + String(f).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!yi(t, "name") || bi && t.name !== f) && wu(t, "name", f), D = Ni(t), D.source || (D.source = Oi.join(typeof f == "string" ? f : ""))), e === Si) {
      n ? e[r] = t : Ti(r, t);
      return;
    } else
...
var qr = T((Pl, Iu) => {
  var qi = Math.ceil, Ii = Math.floor;
  Iu.exports = function(e) {
    var r = +e;
...
var xu = T((kl, Ru) => {
  var Ri = qr(), xi = Math.max, Pi = Math.min;
...
var $u = T((jl, ju) => {
  var ji = Pe(), $i = xu(), Ui = ye(), Mu = function(e) {
    return function(r, t, s) {
      var c = ji(r), n = Ui(c), a = $i(s, n), f;
      if (e && t != t) {
        for (; n > a; )
          if (f = c[a++], f != f)
            return true;
  ...
  ju.exports = { includes: Mu(true), indexOf: Mu(false) };
});
var Vu = T(($l, Gu) => {
  var Gi = te(), Ir = oe(), Vi = Pe(), Xi = $u().indexOf, Hi = Sr(), Uu = Gi([].push);
  Gu.exports = function(e, r) {
    var t = Vi(e), s = 0, c = [], n;
    for (n in t)
      !Ir(Hi, n) && Ir(t, n) && Uu(c, n);
    for (; r.length > s; )
      Ir(t, n = r[s++]) && (~Xi(c, n) || Uu(c, n));
    return c;
  };
});
var Hu = T((Ul, Xu) => {
...
var Wu = T((zu) => {
  var zi = Vu(), Wi = Hu(), Yi = Wi.concat("length", "prototype");
...
var Ju = T((Xl, Ku) => {
  var Qi = ve(), Ki = te(), Ji = Wu(), Zi = Qu(), eo = me(), ro = Ki([].concat);
  Ku.exports = Qi("Reflect", "ownKeys") || function(r) {
    var t = Ji.f(eo(r)), s = Zi.f;
    return s ? ro(t, s(r)) : t;
  };
});
var rn = T((Hl, en) => {
  var Zu = oe(), to = Ju(), uo = mr(), no = Ve();
...
var un = T((zl, tn) => {
  var so = ae(), ao = ue(), io = /#|\.prototype\./, Te = function(e, r) {
    var t = co[oo(e)];
    return t == lo ? true : t == Do ? false : ao(r) ? so(r) : !!r;
  }, oo = Te.normalize = function(e) {
    return String(e).replace(io, ".").toLowerCase();
  }, co = Te.data = {}, Do = Te.NATIVE = "N", lo = Te.POLYFILL = "P";
  tn.exports = Te;
});
var Ye = T((Wl, nn) => {
  var Rr = X(), ho = mr().f, po = Xe(), fo = qu(), Eo = je(), Co = rn(), mo = un();
  nn.exports = function(e, r) {
    var t = e.target, s = e.global, c = e.stat, n, a, f, D, v, i;
    if (s ? a = Rr : c ? a = Rr[t] || Eo(t, {}) : a = (Rr[t] || {}).prototype, a)
      for (f in r) {
        if (v = r[f], e.noTargetGet ? (i = ho(a, f), D = i && i.value) : D = a[f], n = mo(s ? f : t + (c ? "." : "#") + f, e.forced), !n && D !== void 0) {
          if (typeof v == typeof D)
            continue;
          Co(v, D);
        }
        (e.sham || D && D.sham) && po(v, "sham", true), fo(a, f, v, e);
      }
  };
});
var sn = T(() => {
  var go = Ye(), Fo = X();
  go({ global: true }, { globalThis: Fo });
});
var xr = T((Kl, an) => {
  var Ao = xe();
  an.exports = Array.isArray || function(r) {
    return Ao(r) == "Array";
  };
});
var Pr = T((Jl, cn) => {
  var on = te(), vo = _e(), _o = qe(), So = on(on.bind);
  cn.exports = function(e, r) {
    return vo(e), r === void 0 ? e : _o ? So(e, r) : function() {
...
var hn = T((Zl, ln) => {
  "use strict";
  var yo = X(), To = xr(), Bo = ye(), bo = Pr(), wo = yo.TypeError, Dn = function(e, r, t, s, c, n, a, f) {
    for (var D = c, v = 0, i = a ? bo(a, f) : false, l, p; v < s; ) {
      if (v in t) {
...
var dn = T((e2, fn) => {
  var No = fe(), Oo = No("toStringTag"), pn = {};
  pn[Oo] = "z";
  fn.exports = String(pn) === "[object z]";
});
var kr = T((r2, En) => {
  var qo = X(), Io = dn(), Ro = ue(), Qe = xe(), xo = fe(), Po = xo("toStringTag"), ko = qo.Object, Lo = Qe(function() {
    return arguments;
  }()) == "Arguments", Mo = function(e, r) {
    try {
      return e[r];
    } catch {
    }
  };
  En.exports = Io ? Qe : function(e) {
    var r, t, s;
    return e === void 0 ? "Undefined" : e === null ? "Null" : typeof (t = Mo(r = ko(e), Po)) == "string" ? t : Lo ? Qe(r) : (s = Qe(r)) == "Object" && Ro(r.callee) ? "Arguments" : s;
  };
});
var vn = T((t2, An) => {
  var jo = te(), $o = ae(), Cn = ue(), Uo = kr(), Go = ve(), Vo = He(), mn = function() {
  }, Xo = [], gn = Go("Reflect", "construct"), Lr = /^\s*(?:class|function)\b/, Ho = jo(Lr.exec), zo = !Lr.exec(mn), Be = function(r) {
    if (!Cn(r))
      return false;
    try {
      return gn(mn, Xo, r), true;
    } catch {
      return false;
    }
  }, Fn = function(r) {
...
var Tn = T((u2, yn) => {
  var Wo = X(), _n = xr(), Yo = vn(), Qo = he(), Ko = fe(), Jo = Ko("species"), Sn = Wo.Array;
  yn.exports = function(e) {
    var r;
    return _n(e) && (r = e.constructor, Yo(r) && (r === Sn || _n(r.prototype)) ? r = void 0 : Qo(r) && (r = r[Jo], r === null && (r = void 0))), r === void 0 ? Sn : r;
  };
});
var bn = T((n2, Bn) => {
  var Zo = Tn();
...
var jr = T((i2, In) => {
  var Dc = kr(), qn = Me(), lc = Mr(), hc = fe(), pc = hc("iterator");
  In.exports = function(e) {
    if (e != null)
      return qn(e, pc) || qn(e, "@@iterator") || lc[Dc(e)];
  };
});
var xn = T((o2, Rn) => {
  var fc = X(), dc = le(), Ec = _e(), Cc = me(), mc = Le(), gc = jr(), Fc = fc.TypeError;
...
var Gn = T((D2, Un) => {
  var _c = X(), Sc = Pr(), yc = le(), Tc = me(), Bc = Le(), bc = On(), wc = ye(), Mn = sr(), Nc = xn(), Oc = jr(), jn = Ln(), qc = _c.TypeError, Ke = function(e, r) {
    this.stopped = e, this.result = r;
  }, $n = Ke.prototype;
  Un.exports = function(e, r, t) {
    var s = t && t.that, c = !!(t && t.AS_ENTRIES), n = !!(t && t.IS_ITERATOR), a = !!(t && t.INTERRUPTED), f = Sc(r, s), D, v, i, l, p, g, C, m = function(w) {
      return D && jn(D, "normal", w), new Ke(true, w);
    }, B = function(w) {
      return c ? (Tc(w), a ? f(w[0], w[1], m) : f(w[0], w[1])) : a ? f(w, m) : f(w);
    };
    if (n)
      D = e;
    else {
...
ec({ target: "Array", proto: true }, { flatMap: function(r) {
  var t = uc(this), s = nc(t), c;
  return tc(r), c = sc(t, 0), c.length = rc(c, t, t, s, 0, 1, r, arguments.length > 1 ? arguments[1] : void 0), c;
} });
var Pc = Ye();
var kc = Gn();
var Lc = Xn();
...
var us = (e, r, t, s) => {
  if (r && typeof r == "object" || typeof r == "function")
    for (let c of $r(r))
      !Xc.call(e, c) && c !== t && Je(e, c, { get: () => r[c], enumerable: !(s = Gc(r, c)) || s.enumerable });
  return e;
};
var Hc = (e, r, t) => (t = e != null ? Uc(Vc(e)) : {}, us(r || !e || !e.__esModule ? Je(t, "default", { value: e, enumerable: true }) : t, e));
var ns = (e) => us(Je({}, "__esModule", { value: true }), e);
var Jn;
var Zn;
var be;
var O = Fe({ "<define:process>"() {
  Jn = {}, Zn = [], be = { env: Jn, argv: Zn };
} });
var ss = I({ "node_modules/angular-html-parser/lib/compiler/src/chars.js"(e) {
  "use strict";
...
var zc = I({ "node_modules/angular-html-parser/lib/compiler/src/aot/static_symbol.js"(e) {
  "use strict";
  ...
  var t = class {
    ...
    get(s, c, n) {
      n = n || [];
      let a = n.length ? ".".concat(n.join(".")) : "", f = '"'.concat(s, '".').concat(c).concat(a), D = this.cache.get(f);
      return D || (D = new r(s, c, n), this.cache.set(f, D)), D;
    }
  };
  e.StaticSymbolCache = t;
} });
var Wc = I({ "node_modules/angular-html-parser/lib/compiler/src/util.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = /-+([a-z0-9])/g;
  function t(o) {
  ...
  function a(o, d, h) {
    return Array.isArray(o) ? d.visitArray(o, h) : S(o) ? d.visitStringMap(o, h) : o == null || typeof o == "string" || typeof o == "number" || typeof o == "boolean" ? d.visitPrimitive(o, h) : d.visitOther(o, h);
  }
  e.visitValue = a;
  function f(o) {
    return o != null;
  ...
  function l(o, d) {
    let h = Error(o);
    return h[p] = true, d && (h[g] = d), h;
  }
  e.syntaxError = l;
  var p = "ngSyntaxError", g = "ngParseErrors";
  function C(o) {
    return o[p];
  }
  e.isSyntaxError = C;
  ...
  function N(o) {
    ...
    for (let h = 0; h < o.length; h++) {
      ...
      if (F >= 55296 && F <= 56319 && o.length > h + 1) {
        ...
        q >= 56320 && q <= 57343 && (h++, F = (F - 55296 << 10) + q - 56320 + 65536);
      }
      F <= 127 ? d += String.fromCharCode(F) : F <= 2047 ? d += String.fromCharCode(F >> 6 & 31 | 192, F & 63 | 128) : F <= 65535 ? d += String.fromCharCode(F >> 12 | 224, F >> 6 & 63 | 128, F & 63 | 128) : F <= 2097151 && (d += String.fromCharCode(F >> 18 & 7 | 240, F >> 12 & 63 | 128, F >> 6 & 63 | 128, F & 63 | 128));
    }
    return d;
  }
  e.utf8Encode = N;
...
`);
  ...
  e.Version = U;
  var k = typeof window < "u" && window, $ = typeof self < "u" && typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && self, L = typeof globalThis < "u" && globalThis, u = L || k || $;
  e.global = u;
} });
var Yc = I({ "node_modules/angular-html-parser/lib/compiler/src/compile_metadata.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = zc(), t = Wc(), s = /^(?:(?:\[([^\]]+)\])|(?:\(([^\)]+)\)))|(\@[-\w]+)$/;
  function c(h) {
  ...
  var m = class {
    constructor() {
      let { moduleUrl: h, styles: F, styleUrls: q } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      this.moduleUrl = h || null, this.styles = R(F), this.styleUrls = R(q);
    }
  };
  e.CompileStylesheetMetadata = m;
  var B = class {
    constructor(h) {
      let { encapsulation: F, template: q, templateUrl: P, htmlAst: G, styles: H, styleUrls: K, externalStylesheets: z, animations: Y, ngContentSelectors: J, interpolation: Z, isInline: _, preserveWhitespaces: E } = h;
      if (this.encapsulation = F, this.template = q, this.templateUrl = P, this.htmlAst = G, this.styles = R(H), this.styleUrls = R(K), this.externalStylesheets = R(z), this.animations = Y ? k(Y) : [], this.ngContentSelectors = J || [], Z && Z.length != 2)
        throw new Error("'interpolation' should have a start and an end symbol.");
      this.interpolation = Z, this.isInline = _, this.preserveWhitespaces = E;
    }
    toSummary() {
  ...
  var w = class {
    static create(h) {
      let { isHost: F, type: q, isComponent: P, selector: G, exportAs: H, changeDetection: K, inputs: z, outputs: Y, host: J, providers: Z, viewProviders: _, queries: E, guards: A, viewQueries: y, entryComponents: x, template: M, componentViewType: V, rendererType: W, componentFactory: Q } = h, se = {}, Ee = {}, er = {};
      J != null && Object.keys(J).forEach((ee) => {
        let re = J[ee], ie = ee.match(s);
        ie === null ? er[ee] = re : ie[1] != null ? Ee[ie[1]] = re : ie[2] != null && (se[ie[2]] = re);
      });
      let Ae = {};
      z != null && z.forEach((ee) => {
      ...
      let Ne = {};
      return Y != null && Y.forEach((ee) => {
        let re = t.splitAtColon(ee, [ee, ee]);
        Ne[re[0]] = re[1];
      }), new w({ isHost: F, type: q, isComponent: !!P, selector: G, exportAs: H, changeDetection: K, inputs: Ae, outputs: Ne, hostListeners: se, hostProperties: Ee, hostAttributes: er, providers: Z, viewProviders: _, queries: E, guards: A, viewQueries: y, entryComponents: x, template: M, componentViewType: V, rendererType: W, componentFactory: Q });
    }
    constructor(h) {
      let { isHost: F, type: q, isComponent: P, selector: G, exportAs: H, changeDetection: K, inputs: z, outputs: Y, hostListeners: J, hostProperties: Z, hostAttributes: _, providers: E, viewProviders: A, queries: y, guards: x, viewQueries: M, entryComponents: V, template: W, componentViewType: Q, rendererType: se, componentFactory: Ee } = h;
  ...
  var b = class {
    constructor(h) {
      let { type: F, providers: q, declaredDirectives: P, exportedDirectives: G, declaredPipes: H, exportedPipes: K, entryComponents: z, bootstrapComponents: Y, importedModules: J, exportedModules: Z, schemas: _, transitiveModule: E, id: A } = h;
  ...
  var U = class {
    constructor(h, F) {
      let { useClass: q, useValue: P, useExisting: G, useFactory: H, deps: K, multi: z } = F;
      this.token = h, this.useClass = q || null, this.useValue = P, this.useExisting = G, this.useFactory = H || null, this.dependencies = K || null, this.multi = !!z;
    }
  };
  e.ProviderMeta = U;
  function k(h) {
  ...
  function L(h, F, q) {
    let P;
    return q.isInline ? F.type.reference instanceof r.StaticSymbol ? P = "".concat(F.type.reference.filePath, ".").concat(F.type.reference.name, ".html") : P = "".concat(a(h), "/").concat(a(F.type), ".html") : P = q.templateUrl, F.type.reference instanceof r.StaticSymbol ? P : $(P);
  }
...
var we = I({ "node_modules/angular-html-parser/lib/compiler/src/parse_util.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = ss(), t = Yc(), s = class {
    constructor(i, l, p, g) {
    ...
    moveBy(i) {
      let l = this.file.content, p = l.length, g = this.offset, C = this.line, m = this.col;
      for (; g > 0 && i < 0; )
        if (g--, i++, l.charCodeAt(g) == r.$LF) {
          C--;
          let w = l.substr(0, g - 1).lastIndexOf(String.fromCharCode(r.$LF));
          m = w > 0 ? g - w : g;
        } else
          m--;
      for (; g < p && i > 0; ) {
    ...
    getContext(i, l) {
      let p = this.file.content, g = this.offset;
      if (g != null) {
...
` && ++B == l)); )
          ;
        for (m = 0, B = 0; m < i && C < p.length - 1 && (C++, m++, !(p[C] == `
` && ++B == l)); )
          ;
        return { before: p.substring(g, this.offset), after: p.substring(this.offset, C + 1) };
      }
      return null;
    }
  };
  ...
  e.ParseError = f;
  function D(i, l) {
    let p = t.identifierModuleUrl(l), g = p != null ? "in ".concat(i, " ").concat(t.identifierName(l), " in ").concat(p) : "in ".concat(i, " ").concat(t.identifierName(l)), C = new c("", g);
    return new n(new s(C, -1, -1, -1), new s(C, -1, -1, -1));
  }
  e.typeSourceSpan = D;
  function v(i, l, p) {
    let g = "in ".concat(i, " ").concat(l, " in ").concat(p), C = new c("", g);
    return new n(new s(C, -1, -1, -1), new s(C, -1, -1, -1));
  }
  e.r3JitTypeSourceSpan = v;
} });
var Qc = I({ "src/utils/front-matter/parse.js"(e, r) {
  "use strict";
  O();
  ...
  function s(c) {
    ...
    if (!n)
      return { content: c };
    let { startDelimiter: a, language: f, value: D = "", endDelimiter: v } = n.groups, i = f.trim() || "yaml";
    if (a === "+++" && (i = "toml"), i !== "yaml" && a !== v)
      return { content: c };
    let [l] = n;
    return { frontMatter: { type: "front-matter", lang: i, value: D, startDelimiter: a, endDelimiter: v, raw: l.replace(/\n$/, "") }, content: l.replace(/[^\n]/g, " ") + c.slice(l.length) };
  }
  r.exports = s;
} });
var as = I({ "src/utils/get-last.js"(e, r) {
  "use strict";
  O();
  var t = (s) => s[s.length - 1];
  r.exports = t;
} });
var Kc = I({ "src/common/parser-create-error.js"(e, r) {
  "use strict";
  O();
  function t(s, c) {
...
var Zc = Fe({ "node_modules/escape-string-regexp/index.js"() {
  O();
} });
var os = I({ "node_modules/semver/internal/debug.js"(e, r) {
  O();
  var t = typeof be == "object" && be.env && be.env.NODE_DEBUG && /\bsemver\b/i.test(be.env.NODE_DEBUG) ? function() {
...
var cs = I({ "node_modules/semver/internal/constants.js"(e, r) {
  O();
...
var eD = I({ "node_modules/semver/internal/re.js"(e, r) {
  O();
  var { MAX_SAFE_COMPONENT_LENGTH: t } = cs(), s = os();
  e = r.exports = {};
  var c = e.re = [], n = e.src = [], a = e.t = {}, f = 0, D = (v, i, l) => {
    let p = f++;
    s(v, p, i), a[v] = p, n[p] = i, c[p] = new RegExp(i, l ? "g" : void 0);
  };
...
var rD = I({ "node_modules/semver/internal/parse-options.js"(e, r) {
  O();
  var t = ["includePrerelease", "loose", "rtl"], s = (c) => c ? typeof c != "object" ? { loose: true } : t.filter((n) => c[n]).reduce((n, a) => (n[a] = true, n), {}) : {};
  r.exports = s;
} });
var tD = I({ "node_modules/semver/internal/identifiers.js"(e, r) {
  O();
  var t = /^[0-9]+$/, s = (n, a) => {
    let f = t.test(n), D = t.test(a);
    return f && D && (n = +n, a = +a), n === a ? 0 : f && !D ? -1 : D && !f ? 1 : n < a ? -1 : 1;
  }, c = (n, a) => s(a, n);
  r.exports = { compareIdentifiers: s, rcompareIdentifiers: c };
} });
var uD = I({ "node_modules/semver/classes/semver.js"(e, r) {
  O();
  var t = os(), { MAX_LENGTH: s, MAX_SAFE_INTEGER: c } = cs(), { re: n, t: a } = eD(), f = rD(), { compareIdentifiers: D } = tD(), v = class {
    constructor(i, l) {
      ...
      if (!p)
        throw new TypeError("Invalid Version: ".concat(i));
      if (this.raw = i, this.major = +p[1], this.minor = +p[2], this.patch = +p[3], this.major > c || this.major < 0)
    ...
    compare(i) {
      if (t("SemVer.compare", this.version, this.options, i), !(i instanceof v)) {
    ...
    compareMain(i) {
      return i instanceof v || (i = new v(i, this.options)), D(this.major, i.major) || D(this.minor, i.minor) || D(this.patch, i.patch);
    }
    comparePre(i) {
      ...
      let l = 0;
      do {
        let p = this.prerelease[l], g = i.prerelease[l];
        if (t("prerelease compare", l, p, g), p === void 0 && g === void 0)
          return 0;
        if (g === void 0)
          return 1;
        if (p === void 0)
    ...
    compareBuild(i) {
      ...
      let l = 0;
      do {
        let p = this.build[l], g = i.build[l];
        if (t("prerelease compare", l, p, g), p === void 0 && g === void 0)
          return 0;
        if (g === void 0)
          return 1;
...
var Ur = I({ "node_modules/semver/functions/compare.js"(e, r) {
  O();
  var t = uD(), s = (c, n, a) => new t(c, a).compare(new t(n, a));
  r.exports = s;
} });
var nD = I({ "node_modules/semver/functions/lt.js"(e, r) {
  O();
  var t = Ur(), s = (c, n, a) => t(c, n, a) < 0;
  r.exports = s;
} });
var sD = I({ "node_modules/semver/functions/gte.js"(e, r) {
  O();
  var t = Ur(), s = (c, n, a) => t(c, n, a) >= 0;
  r.exports = s;
} });
var aD = I({ "src/utils/arrayify.js"(e, r) {
  "use strict";
  O(), r.exports = (t, s) => Object.entries(t).map((c) => {
    let [n, a] = c;
    return Object.assign({ [s]: n }, a);
  });
} });
var iD = I({ "package.json"(e, r) {
  r.exports = { version: "2.7.1" };
} });
var oD = I({ "node_modules/outdent/lib/index.js"(e, r) {
  "use strict";
  ...
  function c() {
    return { add: t, delete: t, get: t, set: t, has: function(S) {
      return false;
    } };
  }
  var n = Object.prototype.hasOwnProperty, a = function(S, N) {
    return n.call(S, N);
  };
  function f(S, N) {
    for (var b in N)
  ...
  var D = /^[ \t]*(?:\r\n|\r|\n)/, v = /(?:\r\n|\r|\n)[ \t]*$/, i = /^(?:[\r\n]|$)/, l = /(?:\r\n|\r|\n)([ \t]*)(?:[^ \t\r\n]|$)/, p = /^[ \t]*[\r\n][ \t\r\n]*$/;
  function g(S, N, b) {
    var j = 0, R = S[0].match(l);
    R && (j = R[1].length);
    var U = "(\\r\\n|\\r|\\n).{0," + j + "}", k = new RegExp(U, "g");
    N && (S = S.slice(1));
    var $ = b.newline, L = b.trimLeadingNewline, u = b.trimTrailingNewline, o = typeof $ == "string", d = S.length, h = S.map(function(F, q) {
      return F = F.replace(k, "$1"), q === 0 && L && (F = F.replace(D, "")), q === d - 1 && u && (F = F.replace(v, "")), o && (F = F.replace(/\r\n|\n|\r/g, function(P) {
        return $;
      })), F;
    });
    return h;
  ...
  function B(S) {
    ...
    function j(U) {
      for (var k = [], $ = 1; $ < arguments.length; $++)
        k[$ - 1] = arguments[$];
      if (m(U)) {
        var L = U, u = (k[0] === j || k[0] === w) && p.test(L[0]) && i.test(L[1]), o = u ? b : N, d = o.get(L);
    ...
    var R = f(j, { string: function(U) {
      return g([U], false, S)[0];
    } });
    return R;
  }
  var w = B({ trimLeadingNewline: true, trimTrailingNewline: true });
...
var cD = I({ "src/main/core-options.js"(e, r) {
  "use strict";
  O();
  var { outdent: t } = oD(), s = "Config", c = "Editor", n = "Format", a = "Other", f = "Output", D = "Global", v = "Special", i = { cursorOffset: { since: "1.4.0", category: v, type: "int", default: -1, range: { start: -1, end: Number.POSITIVE_INFINITY, step: 1 }, description: t(Hn || (Hn = ge([`
      Print (to stderr) where a cursor at the given position would move to after formatting.
      This option cannot be used with --range-start and --range-end.
    `]))), cliCategory: c }, endOfLine: { since: "1.15.0", category: D, type: "choice", default: [{ since: "1.15.0", value: "auto" }, { since: "2.0.0", value: "lf" }], description: "Which end of line characters to apply.", choices: [{ value: "lf", description: "Line Feed only (\\n), common on Linux and macOS as well as inside git repos" }, { value: "crlf", description: "Carriage Return + Line Feed characters (\\r\\n), common on Windows" }, { value: "cr", description: "Carriage Return character only (\\r), used very rarely" }, { value: "auto", description: t(zn || (zn = ge([`
          Maintain existing
          (mixed values within one file are normalised by looking at what's used after the first line)
        `]))) }] }, filepath: { since: "1.4.0", category: v, type: "path", description: "Specify the input filepath. This will be used to do parser inference.", cliName: "stdin-filepath", cliCategory: a, cliDescription: "Path to the file to pretend that stdin comes from." }, insertPragma: { since: "1.8.0", category: v, type: "boolean", default: false, description: "Insert @format pragma into file's first docblock comment.", cliCategory: a }, parser: { since: "0.0.10", category: D, type: "choice", default: [{ since: "0.0.10", value: "babylon" }, { since: "1.13.0", value: void 0 }], description: "Which parser to use.", exception: (l) => typeof l == "string" || typeof l == "function", choices: [{ value: "flow", description: "Flow" }, { value: "babel", since: "1.16.0", description: "JavaScript" }, { value: "babel-flow", since: "1.16.0", description: "Flow" }, { value: "babel-ts", since: "2.0.0", description: "TypeScript" }, { value: "typescript", since: "1.4.0", description: "TypeScript" }, { value: "acorn", since: "2.6.0", description: "JavaScript" }, { value: "espree", since: "2.2.0", description: "JavaScript" }, { value: "meriyah", since: "2.2.0", description: "JavaScript" }, { value: "css", since: "1.7.1", description: "CSS" }, { value: "less", since: "1.7.1", description: "Less" }, { value: "scss", since: "1.7.1", description: "SCSS" }, { value: "json", since: "1.5.0", description: "JSON" }, { value: "json5", since: "1.13.0", description: "JSON5" }, { value: "json-stringify", since: "1.13.0", description: "JSON.stringify" }, { value: "graphql", since: "1.5.0", description: "GraphQL" }, { value: "markdown", since: "1.8.0", description: "Markdown" }, { value: "mdx", since: "1.15.0", description: "MDX" }, { value: "vue", since: "1.10.0", description: "Vue" }, { value: "yaml", since: "1.14.0", description: "YAML" }, { value: "glimmer", since: "2.3.0", description: "Ember / Handlebars" }, { value: "html", since: "1.15.0", description: "HTML" }, { value: "angular", since: "1.15.0", description: "Angular" }, { value: "lwc", since: "1.17.0", description: "Lightning Web Components" }] }, plugins: { since: "1.10.0", type: "path", array: true, default: [{ value: [] }], category: D, description: "Add a plugin. Multiple plugins can be passed as separate `--plugin`s.", exception: (l) => typeof l == "string" || typeof l == "object", cliName: "plugin", cliCategory: s }, pluginSearchDirs: { since: "1.13.0", type: "path", array: true, default: [{ value: [] }], category: D, description: t(Wn || (Wn = ge([`
      Custom directory that contains prettier plugins in node_modules subdirectory.
      Overrides default behavior when plugins are searched relatively to the location of Prettier.
      Multiple values are accepted.
    `]))), exception: (l) => typeof l == "string" || typeof l == "object", cliName: "plugin-search-dir", cliCategory: s }, printWidth: { since: "0.0.0", category: D, type: "int", default: 80, description: "The line length where Prettier will try wrap.", range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 } }, rangeEnd: { since: "1.4.0", category: v, type: "int", default: Number.POSITIVE_INFINITY, range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 }, description: t(Yn || (Yn = ge([`
      Format code ending at a given character offset (exclusive).
      The range will extend forwards to the end of the selected statement.
      This option cannot be used with --cursor-offset.
    `]))), cliCategory: c }, rangeStart: { since: "1.4.0", category: v, type: "int", default: 0, range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 }, description: t(Qn || (Qn = ge([`
      Format code starting at a given character offset.
      The range will extend backwards to the start of the first line containing the selected statement.
      This option cannot be used with --cursor-offset.
    `]))), cliCategory: c }, requirePragma: { since: "1.7.0", category: v, type: "boolean", default: false, description: t(Kn || (Kn = ge([`
  ...
  r.exports = { CATEGORY_CONFIG: s, CATEGORY_EDITOR: c, CATEGORY_FORMAT: n, CATEGORY_OTHER: a, CATEGORY_OUTPUT: f, CATEGORY_GLOBAL: D, CATEGORY_SPECIAL: v, options: i };
} });
var DD = I({ "src/main/support.js"(e, r) {
  "use strict";
  O();
  var t = { compare: Ur(), lt: nD(), gte: sD() }, s = aD(), c = iD().version, n = cD().options;
  function a() {
    let { plugins: D = [], showUnreleased: v = false, showDeprecated: i = false, showInternal: l = false } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, p = c.split("-", 1)[0], g = D.flatMap((S) => S.languages || []).filter(m), C = s(Object.assign({}, ...D.map((S) => {
      let { options: N } = S;
      return N;
    }), n), "name").filter((S) => m(S) && B(S)).sort((S, N) => S.name === N.name ? 0 : S.name < N.name ? -1 : 1).map(w).map((S) => {
      S = Object.assign({}, S), Array.isArray(S.default) && (S.default = S.default.length === 1 ? S.default[0].value : S.default.filter(m).sort((b, j) => t.compare(j.since, b.since))[0].value), Array.isArray(S.choices) && (S.choices = S.choices.filter((b) => m(b) && B(b)), S.name === "parser" && f(S, g, D));
      let N = Object.fromEntries(D.filter((b) => b.defaultOptions && b.defaultOptions[S.name] !== void 0).map((b) => [b.name, b.defaultOptions[S.name]]));
      return Object.assign(Object.assign({}, S), {}, { pluginDefaults: N });
    });
    ...
    function B(S) {
      return i || !("deprecated" in S) || S.deprecated && t.lt(p, S.deprecated);
    }
    function w(S) {
      if (l)
        return S;
    ...
    for (let p of v)
      if (p.parsers) {
        for (let g of p.parsers)
          if (!l.has(g)) {
            l.add(g);
            let C = i.find((B) => B.parsers && B.parsers[g]), m = p.name;
            C && C.name && (m += " (plugin: ".concat(C.name, ")")), D.choices.push({ value: g, description: m });
          }
      }
  }
  r.exports = { getSupportInfo: a };
} });
var lD = I({ "src/utils/is-non-empty-array.js"(e, r) {
  "use strict";
  O();
  function t(s) {
...
var pD = Fe({ "node_modules/strip-ansi/node_modules/ansi-regex/index.js"() {
  O();
} });
function fD(e) {
  if (typeof e != "string")
...
var dD = Fe({ "node_modules/strip-ansi/index.js"() {
  O(), pD();
} });
function ED(e) {
...
var CD = Fe({ "node_modules/is-fullwidth-code-point/index.js"() {
  O();
} });
var mD = I({ "node_modules/emoji-regex/index.js"(e, r) {
  "use strict";
...
function gD(e) {
  ...
  for (let t = 0; t < e.length; t++) {
    ...
    s <= 31 || s >= 127 && s <= 159 || s >= 768 && s <= 879 || (s > 65535 && t++, r += ED(s) ? 2 : 1);
  }
  return r;
}
var ls;
var FD = Fe({ "node_modules/string-width/index.js"() {
  O(), dD(), CD(), ls = Hc(mD());
} });
var AD = I({ "src/utils/get-string-width.js"(e, r) {
  "use strict";
  O();
  var t = (FD(), ns(Ds)).default, s = /[^\x20-\x7F]/;
  function c(n) {
    return n ? s.test(n) ? t(n) : n.length : 0;
  }
  r.exports = c;
} });
var Gr = I({ "src/utils/text/skip.js"(e, r) {
  "use strict";
  O();
  function t(f) {
    return (D, v, i) => {
...
var ps = I({ "src/utils/text/skip-trailing-comment.js"(e, r) {
  "use strict";
  O();
...
var fs = I({ "src/utils/text/skip-newline.js"(e, r) {
  "use strict";
  O();
  function t(s, c, n) {
    let a = n && n.backwards;
...
var vD = I({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(e, r) {
  "use strict";
  O();
  var t = hs(), s = fs(), c = ps(), { skipSpaces: n } = Gr();
  function a(f, D) {
    let v = null, i = D;
    for (; i !== v; )
...
var _D = I({ "src/common/util.js"(e, r) {
  "use strict";
  O();
  var { default: t } = (Zc(), ns(is)), s = as(), { getSupportInfo: c } = DD(), n = lD(), a = AD(), { skipWhitespace: f, skipSpaces: D, skipToLineEnd: v, skipEverythingButNewLine: i } = Gr(), l = hs(), p = ps(), g = fs(), C = vD(), m = (_) => _[_.length - 2];
  function B(_) {
    return (E, A, y) => {
      let x = y && y.backwards;
      if (A === false)
      ...
      for (; V >= 0 && V < M; ) {
        ...
        if (_ instanceof RegExp) {
          if (!_.test(W))
            return V;
        } else if (!_.includes(W))
          return V;
        x ? V-- : V++;
      }
      return V === -1 || V === M ? V : false;
    };
  }
  function w(_, E) {
    let A = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, y = D(_, A.backwards ? E - 1 : E, A), x = g(_, y, A);
    return y !== x;
  }
  function S(_, E, A) {
    for (let y = E; y < A; ++y)
...
`)
  ...
  function N(_, E, A) {
    let y = A(E) - 1;
    y = D(_, y, { backwards: true }), y = g(_, y, { backwards: true }), y = D(_, y, { backwards: true });
    let x = g(_, y, { backwards: true });
    return y !== x;
  }
  function b(_, E) {
    let A = null, y = E;
    for (; y !== A; )
      A = y, y = v(_, y), y = l(_, y), y = D(_, y);
    return y = p(_, y), y = g(_, y), y !== false && w(_, y);
  }
  function j(_, E, A) {
    return b(_, A(E));
  }
  ...
  function $(_, E) {
    let A = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, y = 0;
...
`);
  ...
  function u(_, E) {
    let A = { quote: '"', regex: /"/g, escaped: "&quot;" }, y = { quote: "'", regex: /'/g, escaped: "&apos;" }, x = E === "'" ? y : A, M = x === y ? A : y, V = x;
    if (_.includes(x.quote) || _.includes(M.quote)) {
      let W = (_.match(x.regex) || []).length, Q = (_.match(M.regex) || []).length;
      V = W > Q ? M : x;
    }
    return V;
  }
  function o(_, E) {
    let A = _.slice(1, -1), y = E.parser === "json" || E.parser === "json5" && E.quoteProps === "preserve" && !E.singleQuote ? '"' : E.__isInHtmlAttribute ? "'" : u(A, E.singleQuote ? "'" : '"').quote;
    return d(A, y, !(E.parser === "css" || E.parser === "less" || E.parser === "scss" || E.__embeddedInHtml));
  }
  function d(_, E, A) {
    let y = E === '"' ? "'" : '"', x = /\\(.)|(["'])/gs, M = _.replace(x, (V, W, Q) => W === y ? W : Q === E ? "\\" + Q : Q || (A && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(W) ? W : "\\" + W));
    return E + M + E;
  }
  function h(_) {
  ...
  function F(_, E) {
    ...
    return A === null ? 0 : A.reduce((y, x) => Math.max(y, x.length / E.length), 0);
  }
  function q(_, E) {
    let A = _.match(new RegExp("(".concat(t(E), ")+"), "g"));
    if (A === null)
      return 0;
    let y = /* @__PURE__ */ new Map(), x = 0;
    for (let M of A) {
      let V = M.length / E.length;
      y.set(V, true), V > x && (x = V);
    }
    for (let M = 1; M < x; M++)
      if (!y.get(M))
        return M;
  ...
  function P(_, E) {
    (_.comments || (_.comments = [])).push(E), E.printed = false, E.nodeDescription = Z(_);
  }
  function G(_, E) {
    E.leading = true, E.trailing = false, P(_, E);
  }
  function H(_, E, A) {
    E.leading = false, E.trailing = false, A && (E.marker = A), P(_, E);
  }
  function K(_, E) {
    E.leading = false, E.trailing = true, P(_, E);
  }
  function z(_, E) {
    let { languages: A } = c({ plugins: E.plugins }), y = A.find((x) => {
      let { name: M } = x;
...
var ds = I({ "src/language-html/utils/array-to-map.js"(e, r) {
  "use strict";
  O();
  function t(s) {
...
var yD = I({ "src/language-html/utils/html-tag-names.js"(e, r) {
  "use strict";
  O();
  var { htmlTagNames: t } = SD(), s = ds(), c = s(t);
  r.exports = c;
} });
var TD = I({ "vendors/html-element-attributes.json"(e, r) {
...
var BD = I({ "src/language-html/utils/map-object.js"(e, r) {
  "use strict";
  O();
  function t(s, c) {
    let n = /* @__PURE__ */ Object.create(null);
    for (let [a, f] of Object.entries(s))
      n[a] = c(f, a);
    return n;
  }
  r.exports = t;
} });
var bD = I({ "src/language-html/utils/html-elements-attributes.js"(e, r) {
  "use strict";
  O();
  var { htmlElementAttributes: t } = TD(), s = BD(), c = ds(), n = s(t, c);
  r.exports = n;
} });
var wD = I({ "src/language-html/utils/is-unknown-namespace.js"(e, r) {
  "use strict";
  O();
  function t(s) {
...
var ND = I({ "src/language-html/pragma.js"(e, r) {
  "use strict";
  O();
  function t(c) {
...
var OD = I({ "src/language-html/ast.js"(e, r) {
  "use strict";
  O();
  var t = { attrs: true, children: true }, s = /* @__PURE__ */ new Set(["parent"]), c = class {
    constructor() {
      let a = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      for (let f of /* @__PURE__ */ new Set([...s, ...Object.keys(a)]))
        this.setProperty(f, a[f]);
    }
    setProperty(a, f) {
      if (this[a] !== f) {
        if (a in t && (f = f.map((D) => this.createChild(D))), !s.has(a)) {
          this[a] = f;
          return;
        }
    ...
    map(a) {
      ...
      for (let D in t) {
        ...
        if (v) {
          let i = n(v, (l) => l.map(a));
          f !== v && (f || (f = new c({ parent: this.parent })), f.setProperty(D, i));
        }
      }
      if (f)
        for (let D in this)
...
var qD = I({ "src/language-html/conditional-comment.js"(e, r) {
  "use strict";
  O();
  var { ParseSourceSpan: t } = we(), s = [{ regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: n }, { regex: /^\[if([^\]]*)]><!$/, parse: a }, { regex: /^<!\s*\[endif]$/, parse: f }];
  function c(D, v) {
    if (D.value)
  ...
  function n(D, v, i) {
    let [, l, p, g] = i, C = 4 + l.length, m = D.sourceSpan.start.moveBy(C), B = m.moveBy(g.length), [w, S] = (() => {
      try {
        return [true, v(g, m).children];
      } catch {
        let N = { type: "text", value: g, sourceSpan: new t(m, B) };
        return [false, [N]];
      }
    })();
    return { type: "ieConditionalComment", complete: w, children: S, condition: p.trim().replace(/\s+/g, " "), sourceSpan: D.sourceSpan, startSourceSpan: new t(D.sourceSpan.start, m), endSourceSpan: new t(B, D.sourceSpan.end) };
  }
  function a(D, v, i) {
    let [, l] = i;
...
var ID = I({ "src/language-html/loc.js"(e, r) {
  "use strict";
  O();
  function t(c) {
...
var Es = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/html_tags.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Ze(), t = class {
    constructor() {
      let { closedByChildren: a, implicitNamespacePrefix: f, contentType: D = r.TagContentType.PARSABLE_DATA, closedByParent: v = false, isVoid: i = false, ignoreFirstLf: l = false } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      this.closedByChildren = {}, this.closedByParent = false, this.canSelfClose = false, a && a.length > 0 && a.forEach((p) => this.closedByChildren[p] = true), this.isVoid = i, this.closedByParent = v || i, this.implicitNamespacePrefix = f || null, this.contentType = D, this.ignoreFirstLf = l;
    }
    isClosedByChild(a) {
...
var RD = I({ "node_modules/angular-html-parser/lib/compiler/src/ast_path.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = class {
    constructor(t) {
...
var Cs = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = RD(), t = class {
    constructor(C, m, B) {
      this.value = C, this.sourceSpan = m, this.i18n = B, this.type = "text";
    }
    visit(C, m) {
  ...
  var c = class {
    constructor(C, m, B, w, S, N) {
      this.switchValue = C, this.type = m, this.cases = B, this.sourceSpan = w, this.switchValueSourceSpan = S, this.i18n = N;
    }
    visit(C, m) {
  ...
  var n = class {
    constructor(C, m, B, w, S) {
      this.value = C, this.expression = m, this.sourceSpan = B, this.valueSourceSpan = w, this.expSourceSpan = S;
    }
    visit(C, m) {
  ...
  var a = class {
    constructor(C, m, B) {
      let w = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null, S = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null, N = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null;
      this.name = C, this.value = m, this.sourceSpan = B, this.valueSpan = w, this.nameSpan = S, this.i18n = N, this.type = "attribute";
    }
    visit(C, m) {
  ...
  var f = class {
    constructor(C, m, B, w) {
      let S = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null, N = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null, b = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : null, j = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : null;
      this.name = C, this.attrs = m, this.children = B, this.sourceSpan = w, this.startSourceSpan = S, this.endSourceSpan = N, this.nameSpan = b, this.i18n = j, this.type = "element";
    }
    visit(C, m) {
  ...
  e.DocType = v;
  function i(C, m) {
    let B = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, w = [], S = C.visit ? (N) => C.visit(N, B) || N.visit(C, B) : (N) => N.visit(C, B);
    return m.forEach((N) => {
      let b = S(N);
      b && w.push(b);
    }), w;
  ...
  function p(C) {
    let m = C.sourceSpan.start.offset, B = C.sourceSpan.end.offset;
    return C instanceof f && (C.endSourceSpan ? B = C.endSourceSpan.end.offset : C.children && C.children.length && (B = p(C.children[C.children.length - 1]).end)), { start: m, end: B };
  }
  function g(C, m) {
    let B = [], w = new class extends l {
      visit(S, N) {
        let b = p(S);
        if (b.start <= m && m < b.end)
          B.push(S);
        else
          return true;
      }
...
var xD = I({ "node_modules/angular-html-parser/lib/compiler/src/assertions.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  function r(c, n) {
    if (n != null) {
    ...
    if (n != null) {
      ...
      t.forEach((D) => {
        if (D.test(a) || D.test(f))
          throw new Error("['".concat(a, "', '").concat(f, "'] contains unusable interpolation symbol."));
      });
    }
  }
  e.assertInterpolationSymbols = s;
} });
var PD = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/interpolation_config.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = xD(), t = class {
    constructor(s, c) {
...
var kD = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/lexer.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = ss(), t = we(), s = PD(), c = Ze(), n;
  (function(u) {
...
`);
    ...
    tokenize() {
      ...
      return this._beginToken(n.EOF), this._endToken([]), new D(U(this.tokens), this.errors);
    }
    ...
    _endToken(u) {
      ...
      let d = new a(this._currentTokenType, u, this._cursor.getSpan(this._currentTokenStart, this._leadingTriviaCodePoints));
    ...
    _createError(u, o) {
      ...
      return this._currentTokenStart = null, this._currentTokenType = null, new g(d);
    }
    handleError(u) {
      if (u instanceof L && (u = this._createError(u.msg, this._cursor.getSpan(u.cursor))), u instanceof g)
    ...
    _requireCharCodeUntilFn(u, o) {
      let d = this._cursor.clone();
      if (this._attemptCharCodeUntilFn(u), this._cursor.clone().diff(d) < o)
    ...
    _decodeEntity() {
      ...
      if (this._cursor.advance(), this._attemptCharCode(r.$HASH)) {
        ...
        if (this._attemptCharCodeUntilFn(S), this._cursor.peek() != r.$SEMICOLON)
        ...
        if (!h)
          throw this._createError(p(d), this._cursor.getSpan(u));
        return h;
      }
    }
    _consumeRawText(u, o) {
    ...
    _consumePrefixAndName() {
      ...
      for (; this._cursor.peek() !== r.$COLON && !w(this._cursor.peek()); )
        this._cursor.advance();
      let d;
      this._cursor.peek() === r.$COLON ? (o = this._cursor.getChars(u), this._cursor.advance(), d = this._cursor.clone()) : d = u, this._requireCharCodeUntilFn(B, o === "" ? 0 : 1);
      let h = this._cursor.getChars(d);
      return [o, h];
    }
    _consumeTagOpen(u) {
      let o, d, h, F = this.tokens.length, q = this._cursor.clone(), P = [];
      try {
        if (!r.isAsciiLetter(this._cursor.peek()))
          throw this._createError(l(this._cursor.peek()), this._cursor.getSpan(u));
        for (h = this._consumeTagOpenStart(u), d = h.parts[0], o = h.parts[1], this._attemptCharCodeUntilFn(m); this._cursor.peek() !== r.$SLASH && this._cursor.peek() !== r.$GT; ) {
          ...
          if (this._attemptCharCodeUntilFn(m), this._attemptCharCode(r.$EQ)) {
            ...
            P.push({ prefix: H, name: K });
          this._attemptCharCodeUntilFn(m);
        }
        this._consumeTagOpenEnd();
      } catch (H) {
        if (H instanceof g) {
          this._cursor = q, h && (this.tokens.length = F), this._beginToken(n.TEXT, u), this._endToken(["<"]);
          return;
        }
        throw H;
      }
      ...
      this._handleFullNameStackForTagOpen(d, o), G === c.TagContentType.RAW_TEXT ? this._consumeRawTextWithTagClose(d, o, false) : G === c.TagContentType.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(d, o, true);
    }
    _consumeRawTextWithTagClose(u, o, d) {
      let h = this._consumeRawText(d, () => !this._attemptCharCode(r.$LT) || !this._attemptCharCode(r.$SLASH) || (this._attemptCharCodeUntilFn(m), !this._attemptStrCaseInsensitive(u ? "".concat(u, ":").concat(o) : o)) ? false : (this._attemptCharCodeUntilFn(m), this._attemptCharCode(r.$GT)));
    ...
    _consumeAttributeValue() {
      ...
      if (this._cursor.peek() === r.$SQ || this._cursor.peek() === r.$DQ) {
        ...
        u = this._processCarriageReturns(d.join("")), this._endToken([u]), this._beginToken(n.ATTR_QUOTE), this._cursor.advance(), this._endToken([String.fromCodePoint(o)]);
      } else {
    ...
    _consumeTagClose(u) {
      if (this._beginToken(n.TAG_CLOSE, u), this._attemptCharCodeUntilFn(m), this._allowHtmComponentClosingTags && this._attemptCharCode(r.$SLASH))
        ...
        this._attemptCharCodeUntilFn(m), this._requireCharCode(r.$GT), this._endToken([o, d]), this._handleFullNameStackForTagClose(o, d);
      }
    }
  ...
  function U(u) {
    ...
    for (let h = 0; h < u.length; h++) {
      let F = u[h];
      d && d.type == n.TEXT && F.type == n.TEXT ? (d.parts[0] += F.parts[0], d.sourceSpan.end = F.sourceSpan.end) : (d = F, o.push(d));
    }
    return o;
  }
  var k = class {
      ...
      if (u() === r.$BACKSLASH)
        if (this.internalState = Object.assign({}, this.state), this.advanceState(this.internalState), u() === r.$n)
          ...
          for (; r.isOctalDigit(u()) && d < 3; )
            h = this.clone(), o += String.fromCodePoint(u()), this.advanceState(this.internalState), d++;
    ...
    decodeHexDigits(u, o) {
      let d = this.input.substr(u.internalState.offset, o), h = parseInt(d, 16);
      if (isNaN(h))
...
var es = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/parser.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = we(), t = Cs(), s = kD(), c = Ze(), n = class extends r.ParseError {
    constructor(i, l, p) {
  ...
  var f = class {
    ...
    parse(i, l, p) {
      let g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, C = arguments.length > 4 ? arguments[4] : void 0, m = (k) => function($) {
        for (var L = arguments.length, u = new Array(L > 1 ? L - 1 : 0), o = 1; o < L; o++)
          u[o - 1] = arguments[o];
        return k($.toLowerCase(), ...u);
      }, B = g ? this.getTagDefinition : m(this.getTagDefinition), w = (k) => B(k).contentType, S = g ? C : m(C), N = C ? (k, $, L, u) => {
        let o = S(k, $, L, u);
        return o !== void 0 ? o : w(k);
      } : w, b = s.tokenize(i, l, N, p), j = p && p.canSelfClose || false, R = p && p.allowHtmComponentClosingTags || false, U = new D(b.tokens, B, j, R, g).build();
  ...
  var D = class {
    constructor(i, l, p, g, C) {
      this.tokens = i, this.getTagDefinition = l, this.canSelfClose = p, this.allowHtmComponentClosingTags = g, this.isTagNameCaseSensitive = C, this._index = -1, this._rootNodes = [], this._errors = [], this._elementStack = [], this._advance();
    }
    build() {
    ...
    _consumeCdata(i) {
      let l = this._advance(), p = this._getText(l), g = this._advanceIf(s.TokenType.CDATA_END);
      this._addToParent(new t.CDATA(p, new r.ParseSourceSpan(i.sourceSpan.start, (g || l).sourceSpan.end)));
    }
    _consumeComment(i) {
      let l = this._advanceIf(s.TokenType.RAW_TEXT), p = this._advanceIf(s.TokenType.COMMENT_END), g = l != null ? l.parts[0].trim() : null, C = new r.ParseSourceSpan(i.sourceSpan.start, (p || l || i).sourceSpan.end);
      this._addToParent(new t.Comment(g, C));
    }
    _consumeDocType(i) {
      let l = this._advanceIf(s.TokenType.RAW_TEXT), p = this._advanceIf(s.TokenType.DOC_TYPE_END), g = l != null ? l.parts[0].trim() : null, C = new r.ParseSourceSpan(i.sourceSpan.start, (p || l || i).sourceSpan.end);
      this._addToParent(new t.DocType(g, C));
    }
    _consumeExpansion(i) {
      let l = this._advance(), p = this._advance(), g = [];
      ...
      this._addToParent(new t.Expansion(l.parts[0], p.parts[0], g, C, l.sourceSpan)), this._advance();
    }
    _parseExpansionCase() {
      let i = this._advance();
      ...
      let C = new D(p, this.getTagDefinition, this.canSelfClose, this.allowHtmComponentClosingTags, this.isTagNameCaseSensitive).build();
      if (C.errors.length > 0)
        return this._errors = this._errors.concat(C.errors), null;
      let m = new r.ParseSourceSpan(i.sourceSpan.start, g.sourceSpan.end), B = new r.ParseSourceSpan(l.sourceSpan.start, g.sourceSpan.end);
      return new t.ExpansionCase(i.parts[0], C.rootNodes, m, i.sourceSpan, B);
    }
    _collectExpansionExpTokens(i) {
      let l = [], p = [s.TokenType.EXPANSION_CASE_EXP_START];
      for (; ; ) {
        if ((this._peek.type === s.TokenType.EXPANSION_FORM_START || this._peek.type === s.TokenType.EXPANSION_CASE_EXP_START) && p.push(this._peek.type), this._peek.type === s.TokenType.EXPANSION_CASE_EXP_END)
...
`) {
    ...
    _consumeStartTag(i) {
      let l = i.parts[0], p = i.parts[1], g = [];
      for (; this._peek.type === s.TokenType.ATTR_NAME; )
        g.push(this._consumeAttr(this._advance()));
      let C = this._getElementFullName(l, p, this._getParentElement()), m = false;
      if (this._peek.type === s.TokenType.TAG_OPEN_END_VOID) {
        this._advance(), m = true;
        let b = this.getTagDefinition(C);
        this.canSelfClose || b.canSelfClose || c.getNsPrefix(C) !== null || b.isVoid || this._errors.push(n.create(C, i.sourceSpan, 'Only void and foreign elements can be self closed "'.concat(i.parts[1], '"')));
      } else
        this._peek.type === s.TokenType.TAG_OPEN_END && (this._advance(), m = false);
      let B = this._peek.sourceSpan.start, w = new r.ParseSourceSpan(i.sourceSpan.start, B), S = new r.ParseSourceSpan(i.sourceSpan.start.moveBy(1), i.sourceSpan.end), N = new t.Element(C, g, [], w, w, void 0, S);
      this._pushElement(N), m && (this._popElement(C), N.endSourceSpan = w);
    }
    _pushElement(i) {
    ...
    _popElement(i) {
      for (let l = this._elementStack.length - 1; l >= 0; l--) {
        ...
        if (!i || (c.getNsPrefix(p.name) ? p.name == i : p.name.toLowerCase() == i.toLowerCase()))
    ...
    _consumeAttr(i) {
      let l = c.mergeNsAndName(i.parts[0], i.parts[1]), p = i.sourceSpan.end, g = "", C, m;
      ...
      return this._peek.type === s.TokenType.ATTR_QUOTE && (p = this._advance().sourceSpan.end, C = new r.ParseSourceSpan(m, p)), new t.Attribute(l, g, new r.ParseSourceSpan(i.sourceSpan.start, p), C, i.sourceSpan);
    }
    _getParentElement() {
    ...
    _getElementFullName(i, l, p) {
      return i === "" && (i = this.getTagDefinition(l).implicitNamespacePrefix || "", i === "" && p != null && (i = c.getNsPrefix(p.name))), c.mergeNsAndName(i, l);
    }
  };
  function v(i, l) {
...
var LD = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/html_parser.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Es(), t = es(), s = es();
  ...
  var c = class extends t.Parser {
    ...
    parse(n, a, f) {
      let D = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, v = arguments.length > 4 ? arguments[4] : void 0;
      return super.parse(n, a, f, D, v);
    }
  };
  e.HtmlParser = c;
} });
var rs = I({ "node_modules/angular-html-parser/lib/angular-html-parser/src/index.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = LD(), t = Ze();
  ...
  function n(a) {
    let f = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, { canSelfClose: D = false, allowHtmComponentClosingTags: v = false, isTagNameCaseSensitive: i = false, getTagContentType: l } = f;
    return c().parse(a, "angular-html-parser", { tokenizeExpansionForms: false, interpolationConfig: void 0, canSelfClose: D, allowHtmComponentClosingTags: v }, i, l);
  }
  e.parse = n;
} });
var MD = I({ "src/language-html/parser-html.js"(e, r) {
  O();
  var { ParseSourceSpan: t, ParseLocation: s, ParseSourceFile: c } = we(), n = Qc(), a = as(), f = Kc(), { inferParserByLanguage: D } = _D(), v = yD(), i = bD(), l = wD(), { hasPragma: p } = ND(), { Node: g } = OD(), { parseIeConditionalComment: C } = qD(), { locStart: m, locEnd: B } = ID();
  function w(b, j, R) {
    let { recognizeSelfClosing: U, normalizeTagName: k, normalizeAttributeName: $, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: u, getTagContentType: o } = j, d = rs(), { RecursiveVisitor: h, visitAll: F } = Cs(), { ParseSourceSpan: q } = we(), { getHtmlTagDefinition: P } = Es(), { rootNodes: G, errors: H } = d.parse(b, { canSelfClose: U, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: u, getTagContentType: o });
    if (R.parser === "vue")
      if (G.some((A) => A.type === "docType" && A.value === "html" || A.type === "element" && A.name.toLowerCase() === "html")) {
        U = true, k = true, $ = true, L = true, u = false;
        let A = d.parse(b, { canSelfClose: U, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: u });
        G = A.rootNodes, H = A.errors;
      } else {
        let A = (y) => {
          if (!y || y.type !== "element" || y.name !== "template")
            return false;
          let x = y.attrs.find((V) => V.name === "lang"), M = x && x.value;
          return !M || D(M, R) === "html";
        };
        if (G.some(A)) {
          let y, x = () => d.parse(b, { canSelfClose: U, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: u }), M = () => y || (y = x()), V = (W) => M().rootNodes.find((Q) => {
            let { startSourceSpan: se } = Q;
            return se && se.start.offset === W.startSourceSpan.start.offset;
          });
          for (let W = 0; W < G.length; W++) {
            let Q = G[W], { endSourceSpan: se, startSourceSpan: Ee } = Q;
            if (se === null)
              H = M().errors, G[W] = V(Q) || Q;
            else if (A(Q)) {
              let Ae = M(), Ne = Ee.end.offset, ee = se.start.offset;
    ...
    if (H.length > 0) {
      let { msg: E, span: { start: A, end: y } } = H[0];
      throw f(E, { start: { line: A.line + 1, column: A.col + 1 }, end: { line: y.line + 1, column: y.col + 1 } });
    }
    let K = (E) => {
      let A = E.name.startsWith(":") ? E.name.slice(1).split(":")[0] : null, y = E.nameSpan.toString(), x = A !== null && y.startsWith("".concat(A, ":")), M = x ? y.slice(A.length + 1) : y;
      ...
      switch (E.type) {
        case "element":
          ...
          for (let A of E.attrs)
            K(A), A.valueSpan ? (A.value = A.valueSpan.toString(), /["']/.test(A.value[0]) && (A.value = A.value.slice(1, -1))) : A.value = null;
          break;
        case "comment":
      ...
      if (E.type === "element" && (k && (!E.namespace || E.namespace === E.tagDefinition.implicitNamespacePrefix || l(E)) && (E.name = Y(E.name, (A) => A in v)), $)) {
        let A = i[E.name] || /* @__PURE__ */ Object.create(null);
        for (let y of E.attrs)
          y.namespace || (y.name = Y(y.name, (x) => E.name in i && (x in i["*"] || x in A)));
      }
    }, Z = (E) => {
      ...
      if (E.type === "element") {
        ...
        !E.namespace || E.namespace === A.implicitNamespacePrefix || l(E) ? E.tagDefinition = A : E.tagDefinition = P("");
      }
    };
    return F(new class extends h {
      visit(E) {
        z(E), _(E), J(E), Z(E);
      }
    }(), G), G;
  ...
  function S(b, j, R) {
    let U = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, { frontMatter: k, content: $ } = U ? n(b) : { frontMatter: null, content: b }, L = new c(b, j.filepath), u = new s(L, 0, 0, 0), o = u.moveBy(b.length), d = { type: "root", sourceSpan: new t(u, o), children: w($, R, j) };
    if (k) {
      let q = new s(L, 0, 0, 0), P = q.moveBy(k.raw.length);
      k.sourceSpan = new t(q, P), d.children.unshift(k);
    }
    let h = new g(d), F = (q, P) => {
      let { offset: G } = P, H = b.slice(0, G).replace(/[^\n\r]/g, " "), z = S(H + q, j, R, false);
      z.sourceSpan = new t(P, a(z.children).sourceSpan.end);
      let Y = z.children[0];
      return Y.length === G ? z.children.shift() : (Y.sourceSpan = new t(Y.sourceSpan.start.moveBy(G), Y.sourceSpan.end), Y.value = Y.value.slice(G)), z;
    };
    return h.walk((q) => {
      if (q.type === "comment") {
        let P = C(q, F);
  ...
  function N() {
    let { name: b, recognizeSelfClosing: j = false, normalizeTagName: R = false, normalizeAttributeName: U = false, allowHtmComponentClosingTags: k = false, isTagNameCaseSensitive: $ = false, getTagContentType: L } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return { parse: (u, o, d) => S(u, Object.assign({ parser: b }, d), { recognizeSelfClosing: j, normalizeTagName: R, normalizeAttributeName: U, allowHtmComponentClosingTags: k, isTagNameCaseSensitive: $, getTagContentType: L }), hasPragma: p, astFormat: "html", locStart: m, locEnd: B };
  }
  r.exports = { parsers: { html: N({ name: "html", recognizeSelfClosing: true, normalizeTagName: true, normalizeAttributeName: true, allowHtmComponentClosingTags: true }), angular: N({ name: "angular" }), vue: N({ name: "vue", recognizeSelfClosing: true, isTagNameCaseSensitive: true, getTagContentType: (b, j, R, U) => {
...
var prettier_esm_parser_html_default = d2;
export {
