...
var J = b((pf, Gr) => {
  ...
  Gr.exports = vt(typeof globalThis == "object" && globalThis) || vt(typeof window == "object" && window) || vt(typeof self == "object" && self) || vt(typeof global == "object" && global) || function() {
    return this;
...
var Nt = b((yf, $r) => {
  var Qh = St(), wt = Function.prototype.call;
  $r.exports = Qh ? wt.bind(wt) : function() {
...
var ds = b((gf, si) => {
  si.exports = function(h, u) {
    return { enumerable: !(h & 1), configurable: !(h & 2), writable: !(h & 4), value: u };
  };
});
var le = b((Af, ai) => {
  var ri = St(), ii = Function.prototype, el = ii.bind, ms = ii.call, tl = ri && el.bind(ms, ms);
  ai.exports = ri ? function(h) {
    return h && tl(h);
  } : function(h) {
    return h && function() {
...
var It = b((Pf, oi) => {
  var ni = le(), sl = ni({}.toString), rl = ni("".slice);
  oi.exports = function(h) {
    return rl(sl(h), 8, -1);
  };
});
var li = b((Tf, hi) => {
  var il = J(), al = le(), nl = be(), ol = It(), ys = il.Object, hl = al("".split);
...
var xs = b((Ef, ui) => {
  var ll = J(), ul = ll.TypeError;
  ui.exports = function(h) {
    if (h == null)
      throw ul("Can't call method on " + h);
    return h;
  };
});
var kt = b((bf, ci) => {
...
var vi = b((If, Ci) => {
  var bi = J(), As = gi(), Ai = bi.process, Pi = bi.Deno, Ti = Ai && Ai.versions || Pi && Pi.version, Ei = Ti && Ti.v8, fe, Dt;
  Ei && (fe = Ei.split("."), Dt = fe[0] > 0 && fe[0] < 4 ? 1 : +(fe[0] + fe[1]));
  !Dt && As && (fe = As.match(/Edge\/(\d+)/), (!fe || fe[1] >= 74) && (fe = As.match(/Chrome\/(\d+)/), fe && (Dt = +fe[1])));
  Ci.exports = Dt;
});
var Ps = b((kf, wi) => {
  var Si = vi(), gl = be();
  wi.exports = !!Object.getOwnPropertySymbols && !gl(function() {
    var h = Symbol();
    return !String(h) || !(Object(h) instanceof Symbol) || !Symbol.sham && Si && Si < 41;
  });
});
var Ts = b((Df, Ni) => {
  var Al = Ps();
...
var Es = b((Ff, Ii) => {
  var Pl = J(), Tl = rt(), El = ue(), bl = yi(), Cl = Ts(), vl = Pl.Object;
  Ii.exports = Cl ? function(h) {
...
var Ft = b((Of, Fi) => {
  var Nl = J(), Il = ue(), kl = Di(), Dl = Nl.TypeError;
  Fi.exports = function(h) {
    if (Il(h))
      return h;
...
var Mi = b((Mf, Bi) => {
  var Ll = J(), bs = Nt(), Cs = ue(), vs = Re(), Ol = Ll.TypeError;
  Bi.exports = function(h, u) {
    var p, d;
    if (u === "string" && Cs(p = h.toString) && !vs(d = bs(p, h)) || Cs(p = h.valueOf) && !vs(d = bs(p, h)) || u !== "string" && Cs(p = h.toString) && !vs(d = bs(p, h)))
      return d;
...
var Lt = b((jf, Ui) => {
  var qi = J(), Bl = Object.defineProperty;
  Ui.exports = function(h, u) {
    try {
      Bl(qi, h, { value: u, configurable: true, writable: true });
    } catch {
      qi[h] = u;
    }
    return u;
...
var Ot = b((qf, zi) => {
  var Ml = J(), Rl = Lt(), _i = "__core-js_shared__", jl = Ml[_i] || Rl(_i, {});
  zi.exports = jl;
});
var Ss = b((Uf, Vi) => {
  var ql = ji(), Ki = Ot();
  ...
  })("versions", []).push({ version: "3.22.2", mode: ql ? "pure" : "global", copyright: "\xA9 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var ws = b((_f, Hi) => {
  var Ul = J(), _l = xs(), zl = Ul.Object;
  Hi.exports = function(h) {
    return zl(_l(h));
  };
});
var Ie = b((zf, Wi) => {
  var Kl = le(), Vl = ws(), Hl = Kl({}.hasOwnProperty);
  Wi.exports = Object.hasOwn || function(u, p) {
    return Hl(Vl(u), p);
  };
});
var Ns = b((Kf, Gi) => {
  var Wl = le(), Gl = 0, Xl = Math.random(), Jl = Wl(1 .toString);
  Gi.exports = function(h) {
    return "Symbol(" + (h === void 0 ? "" : h) + ")_" + Jl(++Gl + Xl, 36);
  };
});
var it = b((Vf, Qi) => {
  var Yl = J(), $l = Ss(), Xi = Ie(), Ql = Ns(), Ji = Ps(), $i = Ts(), Xe = $l("wks"), je = Yl.Symbol, Yi = je && je.for, Zl = $i ? je : je && je.withoutSetter || Ql;
  Qi.exports = function(h) {
    if (!Xi(Xe, h) || !(Ji || typeof Xe[h] == "string")) {
      var u = "Symbol." + h;
      Ji && Xi(je, h) ? Xe[h] = je[h] : $i && Yi ? Xe[h] = Yi(u) : Xe[h] = Zl(u);
    }
    return Xe[h];
  };
});
var sa = b((Hf, ta) => {
  var eu = J(), tu = Nt(), Zi = Re(), ea = Es(), su = Oi(), ru = Mi(), iu = it(), au = eu.TypeError, nu = iu("toPrimitive");
...
var na = b((Gf, aa) => {
  var lu = J(), ia = Re(), ks = lu.document, uu = ia(ks) && ia(ks.createElement);
  aa.exports = function(h) {
    return uu ? ks.createElement(h) : {};
  };
});
var Ds = b((Xf, oa) => {
  var cu = Me(), pu = be(), fu = na();
  oa.exports = !cu && !pu(function() {
...
var Fs = b((la) => {
  var du = Me(), mu = Nt(), yu = ti(), xu = ds(), gu = kt(), Au = Is(), Pu = Ie(), Tu = Ds(), ha = Object.getOwnPropertyDescriptor;
  la.f = du ? ha : function(u, p) {
    if (u = gu(u), p = Au(p), Tu)
      try {
        return ha(u, p);
      } catch {
    ...
    if (Pu(u, p))
      return xu(!mu(yu.f, u, p), u[p]);
  };
});
var ca = b((Yf, ua) => {
  var Eu = Me(), bu = be();
  ua.exports = Eu && bu(function() {
    return Object.defineProperty(function() {
    }, "prototype", { value: 42, writable: false }).prototype != 42;
  });
});
var Ls = b(($f, fa) => {
  var pa = J(), Cu = Re(), vu = pa.String, Su = pa.TypeError;
...
var js = b((ma) => {
  var wu = J(), Nu = Me(), Iu = Ds(), ku = ca(), Bt = Ls(), da = Is(), Du = wu.TypeError, Os = Object.defineProperty, Fu = Object.getOwnPropertyDescriptor, Bs = "enumerable", Ms = "configurable", Rs = "writable";
  ma.f = Nu ? ku ? function(u, p, d) {
    if (Bt(u), p = da(p), Bt(d), typeof u == "function" && p === "prototype" && "value" in d && Rs in d && !d[Rs]) {
      var m = Fu(u, p);
      m && m[Rs] && (u[p] = d.value, d = { configurable: Ms in d ? d[Ms] : m[Ms], enumerable: Bs in d ? d[Bs] : m[Bs], writable: false });
    }
    return Os(u, p, d);
  } : Os : function(u, p, d) {
...
var Mt = b((Zf, ya) => {
  var Lu = Me(), Ou = js(), Bu = ds();
  ya.exports = Lu ? function(h, u, p) {
...
var Rt = b((ed, xa) => {
  var Mu = le(), Ru = ue(), qs = Ot(), ju = Mu(Function.toString);
  Ru(qs.inspectSource) || (qs.inspectSource = function(h) {
    return ju(h);
  });
  xa.exports = qs.inspectSource;
});
var Pa = b((td, Aa) => {
  var qu = J(), Uu = ue(), _u = Rt(), ga = qu.WeakMap;
  Aa.exports = Uu(ga) && /native code/.test(_u(ga));
});
var ba = b((sd, Ea) => {
  var zu = Ss(), Ku = Ns(), Ta = zu("keys");
...
var ka = b((id, Ia) => {
  var Vu = Pa(), Na = J(), _s = le(), Hu = Re(), Wu = Mt(), zs = Ie(), Ks = Ot(), Gu = ba(), Xu = Us(), va = "Object already initialized", Hs = Na.TypeError, Ju = Na.WeakMap, jt, at, qt, Yu = function(h) {
  ...
  Vu || Ks.state ? (ke = Ks.state || (Ks.state = new Ju()), Sa = _s(ke.get), Vs = _s(ke.has), wa = _s(ke.set), jt = function(h, u) {
    if (Vs(ke, h))
      throw new Hs(va);
    ...
    return Vs(ke, h);
  }) : (qe = Gu("state"), Xu[qe] = true, jt = function(h, u) {
    if (zs(h, qe))
      throw new Hs(va);
...
var La = b((ad, Fa) => {
  var Ws = Me(), Qu = Ie(), Da = Function.prototype, Zu = Ws && Object.getOwnPropertyDescriptor, Gs = Qu(Da, "name"), ec = Gs && function() {
  }.name === "something", tc = Gs && (!Ws || Ws && Zu(Da, "name").configurable);
  Fa.exports = { EXISTS: Gs, PROPER: ec, CONFIGURABLE: tc };
});
var ja = b((nd, Ra) => {
  var sc = J(), Oa = ue(), rc = Ie(), Ba = Mt(), ic = Lt(), ac = Rt(), Ma = ka(), nc = La().CONFIGURABLE, oc = Ma.get, hc = Ma.enforce, lc = String(String).split("String");
  (Ra.exports = function(h, u, p, d) {
    var m = d ? !!d.unsafe : false, x = d ? !!d.enumerable : false, A = d ? !!d.noTargetGet : false, g = d && d.name !== void 0 ? d.name : u, E;
    if (Oa(p) && (String(g).slice(0, 7) === "Symbol(" && (g = "[" + String(g).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!rc(p, "name") || nc && p.name !== g) && Ba(p, "name", g), E = hc(p), E.source || (E.source = lc.join(typeof g == "string" ? g : ""))), h === sc) {
      x ? h[u] = p : ic(u, p);
      return;
    } else
      m ? !A && h[u] && (x = true) : delete h[u];
    x ? h[u] = p : Ba(h, u, p);
...
var Xs = b((od, qa) => {
  var uc = Math.ceil, cc = Math.floor;
...
var _a = b((hd, Ua) => {
  var pc = Xs(), fc = Math.max, dc = Math.min;
...
var Ga = b((cd, Wa) => {
  var gc = kt(), Ac = _a(), Pc = Ut(), Ha = function(h) {
    return function(u, p, d) {
      var m = gc(u), x = Pc(m), A = Ac(d, x), g;
      if (h && p != p) {
        for (; x > A; )
          if (g = m[A++], g != g)
            return true;
  ...
  Wa.exports = { includes: Ha(true), indexOf: Ha(false) };
});
var Ya = b((pd, Ja) => {
  var Tc = le(), Js = Ie(), Ec = kt(), bc = Ga().indexOf, Cc = Us(), Xa = Tc([].push);
  Ja.exports = function(h, u) {
    var p = Ec(h), d = 0, m = [], x;
    for (x in p)
      !Js(Cc, x) && Js(p, x) && Xa(m, x);
    for (; u.length > d; )
      Js(p, x = u[d++]) && (~bc(m, x) || Xa(m, x));
    return m;
  };
});
var Qa = b((fd, $a) => {
...
var en = b((Za) => {
  ...
  Za.f = Object.getOwnPropertyNames || function(u) {
    return vc(u, wc);
  };
});
var sn = b((tn) => {
...
var an = b((yd, rn) => {
  var Nc = rt(), Ic = le(), kc = en(), Dc = sn(), Fc = Ls(), Lc = Ic([].concat);
  rn.exports = Nc("Reflect", "ownKeys") || function(u) {
    var p = kc.f(Fc(u)), d = Dc.f;
    return d ? Lc(p, d(u)) : p;
  };
});
var hn = b((xd, on) => {
  var nn = Ie(), Oc = an(), Bc = Fs(), Mc = js();
...
var un = b((gd, ln) => {
  var Rc = be(), jc = ue(), qc = /#|\.prototype\./, nt = function(h, u) {
    var p = _c[Uc(h)];
    return p == Kc ? true : p == zc ? false : jc(u) ? Rc(u) : !!u;
  }, Uc = nt.normalize = function(h) {
    return String(h).replace(qc, ".").toLowerCase();
  }, _c = nt.data = {}, zc = nt.NATIVE = "N", Kc = nt.POLYFILL = "P";
  ln.exports = nt;
});
var $s = b((Ad, cn) => {
  var Ys = J(), Vc = Fs().f, Hc = Mt(), Wc = ja(), Gc = Lt(), Xc = hn(), Jc = un();
  cn.exports = function(h, u) {
    var p = h.target, d = h.global, m = h.stat, x, A, g, E, F, D;
    if (d ? A = Ys : m ? A = Ys[p] || Gc(p, {}) : A = (Ys[p] || {}).prototype, A)
      for (g in u) {
        if (F = u[g], h.noTargetGet ? (D = Vc(A, g), E = D && D.value) : E = A[g], x = Jc(d ? g : p + (m ? "." : "#") + g, h.forced), !x && E !== void 0) {
          if (typeof F == typeof E)
            continue;
          Xc(F, E);
        }
        (h.sham || E && E.sham) && Hc(F, "sham", true), Wc(A, g, F, h);
      }
  };
});
var pn = b(() => {
  var Yc = $s(), $c = J();
  Yc({ global: true }, { globalThis: $c });
});
var Qs = b((Ed, fn) => {
  var Qc = It();
  fn.exports = Array.isArray || function(u) {
    return Qc(u) == "Array";
  };
});
var yn = b((bd, mn) => {
  var dn = le(), Zc = Ft(), ep = St(), tp = dn(dn.bind);
  mn.exports = function(h, u) {
    return Zc(h), u === void 0 ? h : ep ? tp(h, u) : function() {
...
var An = b((Cd, gn) => {
  "use strict";
  var sp = J(), rp = Qs(), ip = Ut(), ap = yn(), np = sp.TypeError, xn = function(h, u, p, d, m, x, A, g) {
    for (var E = m, F = 0, D = A ? ap(A, g) : false, C, M; F < d; ) {
      if (F in p) {
...
var En = b((vd, Tn) => {
  var op = it(), hp = op("toStringTag"), Pn = {};
  Pn[hp] = "z";
  Tn.exports = String(Pn) === "[object z]";
});
var Cn = b((Sd, bn) => {
  var lp = J(), up = En(), cp = ue(), _t = It(), pp = it(), fp = pp("toStringTag"), dp = lp.Object, mp = _t(function() {
    return arguments;
  }()) == "Arguments", yp = function(h, u) {
    try {
      return h[u];
    } catch {
    }
  };
  bn.exports = up ? _t : function(h) {
    var u, p, d;
    return h === void 0 ? "Undefined" : h === null ? "Null" : typeof (p = yp(u = dp(h), fp)) == "string" ? p : mp ? _t(u) : (d = _t(u)) == "Object" && cp(u.callee) ? "Arguments" : d;
  };
});
var kn = b((wd, In) => {
  var xp = le(), gp = be(), vn = ue(), Ap = Cn(), Pp = rt(), Tp = Rt(), Sn = function() {
  }, Ep = [], wn = Pp("Reflect", "construct"), Zs = /^\s*(?:class|function)\b/, bp = xp(Zs.exec), Cp = !Zs.exec(Sn), ot = function(u) {
    if (!vn(u))
      return false;
    try {
      return wn(Sn, Ep, u), true;
    } catch {
      return false;
    }
  }, Nn = function(u) {
  ...
  Nn.sham = true;
  In.exports = !wn || gp(function() {
    var h;
    return ot(ot.call) || !ot(Object) || !ot(function() {
      h = true;
    }) || h;
  }) ? Nn : ot;
});
var On = b((Nd, Ln) => {
  var vp = J(), Dn = Qs(), Sp = kn(), wp = Re(), Np = it(), Ip = Np("species"), Fn = vp.Array;
  Ln.exports = function(h) {
    var u;
    return Dn(h) && (u = h.constructor, Sp(u) && (u === Fn || Dn(u.prototype)) ? u = void 0 : wp(u) && (u = u[Ip], u === null && (u = void 0))), u === void 0 ? Fn : u;
  };
});
var Mn = b((Id, Bn) => {
  var kp = On();
...
Dp({ target: "Array", proto: true }, { flatMap: function(u) {
  var p = Op(this), d = Bp(p), m;
  return Lp(u), m = Mp(p, 0), m.length = Fp(m, p, p, d, 0, 1, u, arguments.length > 1 ? arguments[1] : void 0), m;
} });
var Rn;
var jn;
var qn;
...
var _n;
function ht(h, u) {
  return u || (u = h.slice(0)), Object.freeze(Object.defineProperties(h, { raw: { value: Object.freeze(u) } }));
}
...
var qp = (h, u) => {
  for (var p in u)
    rr(h, p, { get: u[p], enumerable: true });
};
var Up = (h, u, p, d) => {
  if (u && typeof u == "object" || typeof u == "function")
    for (let m of ir(u))
      !jp.call(h, m) && m !== p && rr(h, m, { get: () => u[m], enumerable: !(d = Rp(u, m)) || d.enumerable });
  return h;
};
var _p = (h) => Up(rr({}, "__esModule", { value: true }), h);
var H = zn({ "<define:process>"() {
} });
var zp = W({ "src/utils/try-combinations.js"(h, u) {
  "use strict";
  H();
  function p() {
    let d;
...
var Kn = W({ "src/language-js/utils/get-shebang.js"(h, u) {
  "use strict";
  H();
  function p(d) {
    if (!d.startsWith("#!"))
...
var Kp = W({ "src/utils/text/skip-inline-comment.js"(h, u) {
  "use strict";
  H();
  function p(d, m) {
    if (m === false)
...
var Vp = W({ "src/utils/text/skip-newline.js"(h, u) {
  "use strict";
  H();
  function p(d, m, x) {
    let A = x && x.backwards;
...
var Vn = W({ "src/utils/text/skip.js"(h, u) {
  "use strict";
  H();
  function p(g) {
    return (E, F, D) => {
      ...
      for (; L >= 0 && L < M; ) {
        ...
        if (g instanceof RegExp) {
          if (!g.test(k))
            return L;
        } else if (!g.includes(k))
          return L;
        C ? L-- : L++;
      }
      return L === -1 || L === M ? L : false;
    };
  }
  var d = p(/\s/), m = p(" 	"), x = p(",; 	"), A = p(/[^\n\r]/);
  u.exports = { skipWhitespace: d, skipSpaces: m, skipToLineEnd: x, skipEverythingButNewLine: A };
} });
var Hp = W({ "src/utils/text/skip-trailing-comment.js"(h, u) {
  "use strict";
  H();
  var { skipEverythingButNewLine: p } = Vn();
  function d(m, x) {
    return x === false ? false : m.charAt(x) === "/" && m.charAt(x + 1) === "/" ? p(m, x) : x;
  }
  u.exports = d;
} });
var Wp = W({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(h, u) {
  "use strict";
  H();
  var p = Kp(), d = Vp(), m = Hp(), { skipSpaces: x } = Vn();
  function A(g, E) {
    let F = null, D = E;
    for (; D !== F; )
...
var Hn = {};
qp(Hn, { EOL: () => sr, arch: () => Gp, cpus: () => Qn, default: () => ro, endianness: () => Wn, freemem: () => Yn, getNetworkInterfaces: () => so, hostname: () => Gn, loadavg: () => Xn, networkInterfaces: () => to, platform: () => Xp, release: () => eo, tmpDir: () => er, tmpdir: () => tr, totalmem: () => $n, type: () => Zn, uptime: () => Jn });
function Wn() {
  if (typeof zt > "u") {
    var h = new ArrayBuffer(2), u = new Uint8Array(h), p = new Uint16Array(h);
...
var sr;
var ro;
var Jp = zn({ "node-modules-polyfills:os"() {
  H(), tr = er, sr = `
`, ro = { EOL: sr, tmpdir: tr, tmpDir: er, networkInterfaces: to, getNetworkInterfaces: so, release: eo, type: Zn, cpus: Qn, totalmem: $n, freemem: Yn, uptime: Jn, loadavg: Xn, hostname: Gn, endianness: Wn };
} });
var Yp = W({ "node-modules-polyfills-commonjs:os"(h, u) {
  H();
  var p = (Jp(), _p(Hn));
  if (p && p.default) {
    u.exports = p.default;
...
var $p = W({ "node_modules/detect-newline/index.js"(h, u) {
  "use strict";
  H();
  var p = (d) => {
    if (typeof d != "string")
...
var Qp = W({ "node_modules/jest-docblock/build/index.js"(h) {
  "use strict";
  H(), Object.defineProperty(h, "__esModule", { value: true }), h.extract = L, h.parse = G, h.parseWithComments = Z, h.print = B, h.strip = k;
  function u() {
    let l = Yp();
    return u = function() {
      return l;
  ...
  function Z(l) {
    ...
    let Q = /* @__PURE__ */ Object.create(null), Ce = l.replace(D, "").replace(E, "").trimRight(), ee;
    for (; ee = D.exec(l); ) {
      let U = ee[2].replace(g, "");
      typeof Q[ee[1]] == "string" || Array.isArray(Q[ee[1]]) ? Q[ee[1]] = M.concat(Q[ee[1]], U) : Q[ee[1]] = U;
    }
    return { comments: Ce, pragmas: Q };
  }
  function B(l) {
    let { comments: Y = "", pragmas: ie = {} } = l, Q = (0, p().default)(Y) || u().EOL, Ce = "/**", ee = " *", U = " */", O = Object.keys(ie), P = O.map((V) => j(V, ie[V])).reduce((V, $) => V.concat($), []).map((V) => ee + " " + V + Q).join("");
    if (!Y) {
      if (O.length === 0)
        return "";
    ...
    let De = Y.split(Q).map((V) => "".concat(ee, " ").concat(V)).join(Q) + Q;
...
var Zp = W({ "src/common/end-of-line.js"(h, u) {
  "use strict";
  H();
  function p(A) {
    let g = A.indexOf("\r");
    return g >= 0 ? A.charAt(g + 1) === `
` ? "crlf" : "cr" : "lf";
  }
  function d(A) {
    switch (A) {
...
`);
  ...
  u.exports = { guessEndOfLine: p, convertEndOfLineToChars: d, countEndOfLineChars: m, normalizeEndOfLine: x };
} });
var ef = W({ "src/language-js/pragma.js"(h, u) {
  "use strict";
  H();
  var { parseWithComments: p, strip: d, extract: m, print: x } = Qp(), { normalizeEndOfLine: A } = Zp(), g = Kn();
  function E(C) {
    let M = g(C);
    M && (C = C.slice(M.length + 1));
    let L = m(C), { pragmas: k, comments: G } = p(L);
  ...
  function D(C) {
    let { shebang: M, text: L, pragmas: k, comments: G } = E(C), Z = d(L), B = x({ pragmas: Object.assign({ format: "" }, k), comments: G.trimStart() });
    return (M ? "".concat(M, `
`) : "") + A(B) + (Z.startsWith(`
`) ? `
` : `
...
var io = W({ "src/utils/is-non-empty-array.js"(h, u) {
  "use strict";
  H();
  function p(d) {
...
var ao = W({ "src/language-js/loc.js"(h, u) {
  "use strict";
  H();
  var p = io();
  function d(E, F) {
...
var no = W({ "src/language-js/parse/utils/create-parser.js"(h, u) {
  "use strict";
  H();
  var { hasPragma: p } = ef(), { locStart: d, locEnd: m } = ao();
  function x(A) {
    return A = typeof A == "function" ? { parse: A } : A, Object.assign({ astFormat: "estree", hasPragma: p, locStart: d, locEnd: m }, A);
  }
  u.exports = x;
} });
var ar = W({ "src/common/parser-create-error.js"(h, u) {
  "use strict";
  H();
  function p(d, m) {
    let x = new SyntaxError(d + " (" + m.start.line + ":" + m.start.column + ")");
    return x.loc = m, x;
  }
  u.exports = p;
} });
var oo = W({ "src/language-js/parse/utils/create-babel-parse-error.js"(h, u) {
  "use strict";
  H();
  var p = ar();
  function d(m) {
    let { message: x, loc: A } = m;
    return p(x.replace(/ \(.*\)/, ""), { start: { line: A ? A.line : 0, column: A ? A.column + 1 : 0 } });
  }
  u.exports = d;
} });
var tf = W({ "src/language-js/utils/is-ts-keyword-type.js"(h, u) {
  "use strict";
  H();
  function p(d) {
    let { type: m } = d;
...
var sf = W({ "src/language-js/utils/is-block-comment.js"(h, u) {
  "use strict";
  H();
  var p = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), d = (m) => p.has(m == null ? void 0 : m.type);
  u.exports = d;
} });
var rf = W({ "src/language-js/utils/is-type-cast-comment.js"(h, u) {
  "use strict";
  H();
  var p = sf();
  function d(m) {
...
var af = W({ "src/utils/get-last.js"(h, u) {
  "use strict";
  H();
  var p = (d) => d[d.length - 1];
  u.exports = p;
} });
var ho = W({ "src/language-js/parse/postprocess/visit-node.js"(h, u) {
  "use strict";
  H();
  function p(d, m) {
    if (Array.isArray(d)) {
...
var lo = W({ "src/language-js/parse/postprocess/throw-syntax-error.js"(h, u) {
  "use strict";
  H();
  var p = ar();
  function d(m, x) {
    let { start: A, end: g } = m.loc;
    throw p(x, { start: { line: A.line, column: A.column + 1 }, end: { line: g.line, column: g.column + 1 } });
  }
  u.exports = d;
} });
var nf = W({ "src/language-js/parse/postprocess/typescript.js"(h, u) {
  "use strict";
  H();
  var p = ho(), d = lo();
  function m(g, E, F) {
    ...
    if (!Array.isArray(D))
      return;
    let C = E.decorators;
    (!Array.isArray(C) || C.length !== D.length || D.some((M) => {
      let L = F.get(M);
      return !L || !C.includes(L);
    })) && d(E, "Leading decorators must be attached to a class declaration");
  }
  function x(g, E) {
    g.kind !== 167 || g.modifiers && !g.modifiers.some((C) => C.kind === 126) || g.initializer && E.value === null && d(E, "Abstract property cannot have an initializer");
  }
  function A(g, E) {
    let { esTreeNodeToTSNodeMap: F, tsNodeToESTreeNodeMap: D } = E.tsParseResult;
    p(g, (C) => {
      let M = F.get(C);
      if (!M)
        return;
...
var of = W({ "src/language-js/parse/postprocess/index.js"(h, u) {
  "use strict";
  H();
  var { locStart: p, locEnd: d } = ao(), m = tf(), x = rf(), A = af(), g = ho(), { throwErrorForInvalidNodes: E } = nf(), F = lo();
  function D(k, G) {
    if (G.parser === "typescript" && /@|abstract/.test(G.originalText) && E(k, G), G.parser !== "typescript" && G.parser !== "flow" && G.parser !== "acorn" && G.parser !== "espree" && G.parser !== "meriyah") {
  ...
  function L(k) {
    return M(k) ? L({ type: "LogicalExpression", operator: k.operator, left: L({ type: "LogicalExpression", operator: k.operator, left: k.left, right: k.right.left, range: [p(k.left), d(k.right.left)] }), right: k.right.right, range: [p(k), d(k)] }) : k;
  }
  u.exports = D;
} });
var uo = W({ "node_modules/@babel/parser/lib/index.js"(h) {
  "use strict";
  H(), Object.defineProperty(h, "__esModule", { value: true });
  function u(t, e) {
    if (t == null)
      return {};
  ...
  var x = Object.freeze({ SyntaxError: "BABEL_PARSER_SYNTAX_ERROR", SourceTypeModuleError: "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED" }), A = function(t) {
    ...
    return e === "UpdateExpression" ? F.UpdateExpression[String(s)] : F[e];
  }, C = (t) => ({ AccessorIsGenerator: t((e) => {
    let { kind: s } = e;
  ...
  function j(t, e) {
    ...
    for (let i of Object.keys(s))
      r[i] = Z(Object.assign({ code: x.SyntaxError, reasonCode: i }, e ? { syntaxPlugin: e } : {}, s[i]));
    return r;
  }
  var l = Object.assign({}, j(E), j(C), j(M), j(Rn || (Rn = ht(["pipelineOperator"])))(k)), { defineProperty: Y } = Object, ie = (t, e) => Y(t, e, { enumerable: false, value: t[e] });
  function Q(t) {
    return ie(t.loc.start, "index"), ie(t.loc.end, "index"), t;
  }
  var Ce = (t) => class extends t {
    parse() {
      let e = Q(super.parse());
  ...
  var O = true, P = true, De = true, V = true, $ = true, me = true, ce = class {
    constructor(t) {
  ...
  function ge(t) {
    return t < 65 ? t === 36 : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && Co.test(String.fromCharCode(t)) : Wt(t, lr);
  }
  function ze(t) {
    return t < 48 ? t === 36 : t < 58 ? true : t < 65 ? false : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && vo.test(String.fromCharCode(t)) : Wt(t, lr) || Wt(t, So);
  }
  var Gt = { keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"], strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"], strictBind: ["eval", "arguments"] }, wo = new Set(Gt.keyword), No = new Set(Gt.strict), Io = new Set(Gt.strictBind);
  function ur(t, e) {
  ...
  var Fo = /* @__PURE__ */ new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
  function Lo(t) {
    return Fo.has(t);
  }
  var Ke = 0, $e = 1, Ae = 2, Xt = 4, dr = 8, ct = 16, mr = 32, Fe = 64, Jt = 128, pt = 256, ft = $e | Ae | pt, Pe = 1, Ve = 2, yr = 4, Se = 8, dt = 16, xr = 64, mt = 128, Yt = 256, $t = 512, Qt = 1024, Zt = 2048, gr = Pe | Ve | Se | mt, Te = Pe | 0 | Se | 0, yt = Pe | 0 | yr | 0, Ar = Pe | 0 | dt | 0, Oo = 0 | Ve | 0 | mt, Bo = 0 | Ve | 0 | 0, Pr = Pe | Ve | Se | Yt, Tr = 0 | Qt, Le = 0 | xr, Mo = Pe | 0 | 0 | xr, Ro = Pr | $t, jo = 0 | Qt, qo = Zt, xt = 4, es = 2, ts = 1, ss = es | ts, Uo = es | xt, _o = ts | xt, zo = es, Ko = ts, rs = 0, Vo = class {
    constructor() {
  ...
  var Wo = class extends Vo {
    ...
    finalizeComment(t) {
      ...
      if (t.leadingNode !== null || t.trailingNode !== null)
        t.leadingNode !== null && Er(t.leadingNode, e), t.trailingNode !== null && Ho(t.trailingNode, e);
      else {
  ...
  var Cr = class {
    ...
    clone(t) {
      let e = new Cr(), s = Object.keys(this);
  ...
  }, Jo = ["at"], Yo = ["at"], $o = function(e) {
    return e >= 48 && e <= 57;
  }, Qo = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), vr = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, At = { bin: (t) => t === 48 || t === 49, oct: (t) => t >= 48 && t <= 55, dec: (t) => t >= 48 && t <= 57, hex: (t) => t >= 48 && t <= 57 || t >= 65 && t <= 70 || t >= 97 && t <= 102 }, we = class {
    constructor(t) {
      this.type = t.type, this.value = t.value, this.start = t.start, this.end = t.end, this.loc = new d(t.startLoc, t.endLoc);
    }
  }, Zo = class extends Wo {
    constructor(t, e) {
      super(), this.isLookahead = void 0, this.tokens = [], this.state = new Cr(), this.state.init(t), this.input = e, this.length = e.length, this.isLookahead = false;
    }
    pushToken(t) {
      this.tokens.length = this.state.tokensLength, this.tokens.push(t), ++this.state.tokensLength;
    }
    next() {
      this.checkKeywordEscapes(), this.options.tokens && this.pushToken(new we(this.state)), this.state.lastTokStart = this.state.start, this.state.lastTokEndLoc = this.state.endLoc, this.state.lastTokStartLoc = this.state.startLoc, this.nextToken();
    }
    eat(t) {
    ...
    skipBlockComment() {
      ...
      for (this.state.pos = s + 2, gt.lastIndex = e + 2; gt.test(this.input) && gt.lastIndex <= s; )
    ...
    readToken_numberSign() {
      ...
      if (e === 123 || e === 91 && this.hasPlugin("recordAndTuple")) {
        ...
        ge(e) ? (++this.state.pos, this.finishToken(134, this.readWord1(e))) : e === 92 ? (++this.state.pos, this.finishToken(134, this.readWord1())) : this.finishOp(27, 1);
    }
    readToken_dot() {
    ...
    readToken_interpreter() {
      ...
      for (this.state.pos += 1; !Oe(t) && ++this.state.pos < this.length; )
    ...
    readInt(t, e, s) {
      let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, i = this.state.pos, a = t === 16 ? vr.hex : vr.decBinOct, n = t === 16 ? At.hex : t === 10 ? At.dec : t === 8 ? At.oct : At.bin, o = false, c = 0;
      for (let f = 0, y = e == null ? 1 / 0 : e; f < y; ++f) {
        let T = this.input.charCodeAt(this.state.pos), v;
        if (T === 95 && r !== "bail") {
          let N = this.input.charCodeAt(this.state.pos - 1), R = this.input.charCodeAt(this.state.pos + 1);
          r ? (Number.isNaN(R) || !n(R) || a.has(N) || a.has(R)) && this.raise(l.UnexpectedNumericSeparator, { at: this.state.curPosition() }) : this.raise(l.NumericSeparatorInEscapeSequence, { at: this.state.curPosition() }), ++this.state.pos;
          continue;
        }
        if (T >= 97 ? v = T - 97 + 10 : T >= 65 ? v = T - 65 + 10 : $o(T) ? v = T - 48 : v = 1 / 0, v >= t)
    ...
    readNumber(t) {
      ...
      if (c) {
        ...
        if (this.recordStrictModeErrors(l.StrictOctalLiteral, { at: s }), !this.state.strict) {
          let N = v.indexOf("_");
          N > 0 && this.raise(l.ZeroDigitNumericSeparator, { at: m(s, N) });
        }
        o = c && !/[89]/.test(v);
      }
      let f = this.input.charCodeAt(this.state.pos);
      if (f === 46 && !o && (++this.state.pos, this.readInt(10), r = true, f = this.input.charCodeAt(this.state.pos)), (f === 69 || f === 101) && !o && (f = this.input.charCodeAt(++this.state.pos), (f === 43 || f === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(l.InvalidOrMissingExponent, { at: s }), r = true, n = true, f = this.input.charCodeAt(this.state.pos)), f === 110 && ((r || c) && this.raise(l.InvalidBigIntLiteral, { at: s }), ++this.state.pos, i = true), f === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (n || c) && this.raise(l.InvalidDecimal, { at: s }), ++this.state.pos, a = true), ge(this.codePointAtPos(this.state.pos)))
        throw this.raise(l.NumberIdentifier, { at: this.state.curPosition() });
    ...
    readTemplateToken() {
      ...
      for (++this.state.pos; ; ) {
        if (this.state.pos >= this.length)
          throw this.raise(l.UnterminatedTemplate, { at: m(this.state.startLoc, 1) });
        let r = this.input.charCodeAt(this.state.pos);
        if (r === 96) {
...
`;
        ...
        case 57:
          if (t)
            return null;
          this.recordStrictModeErrors(l.StrictNumericEscape, { at: m(this.state.curPosition(), -1) });
        default:
          if (s >= 48 && s <= 55) {
    ...
    readHexChar(t, e, s) {
      ...
      return i === null && (s ? this.raise(l.InvalidEscapeSequence, { at: r }) : this.state.pos = r.index - 1), i;
    }
    readWord1(t) {
      ...
      for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
        ...
        if (ze(i))
          ...
          let a = this.state.curPosition(), n = this.state.pos === s ? ge : ze;
          ...
          o !== null && (n(o) || this.raise(l.EscapedCharNotAnIdentifier, { at: a }), e += String.fromCodePoint(o)), r = this.state.pos;
        } else
          break;
      }
    ...
    readWord(t) {
      let e = this.readWord1(t), s = ae.get(e);
      s !== void 0 ? this.finishToken(s, ve(s)) : this.finishToken(128, e);
    }
    checkKeywordEscapes() {
      let { type: t } = this.state;
      Vt(t) && this.state.containsEsc && this.raise(l.InvalidEscapedReservedWord, { at: this.state.startLoc, reservedWord: ve(t) });
    }
    raise(t, e) {
      let { at: s } = e, r = u(e, Jo), i = s instanceof p ? s : s.loc.start, a = t({ loc: i, details: r });
      if (!this.options.errorRecovery)
        throw a;
      return this.isLookahead || this.state.errors.push(a), a;
    }
    raiseOverwrite(t, e) {
      let { at: s } = e, r = u(e, Yo), i = s instanceof p ? s : s.loc.start, a = i.index, n = this.state.errors;
    ...
    unexpected(t, e) {
      throw this.raise(l.UnexpectedToken, { expected: e ? ve(e) : null, at: t != null ? t : this.state.startLoc });
    }
    expectPlugin(t, e) {
      if (this.hasPlugin(t))
        return true;
    ...
    treatFunctionsAsVarInScope(t) {
      return !!(t.flags & (Ae | Jt) || !this.parser.inModule && t.flags & $e);
    }
    declareName(t, e, s) {
      let r = this.currentScope();
      if (e & Se || e & dt)
        this.checkRedeclarationInScope(r, t, e, s), e & dt ? r.functions.add(t) : r.lexical.add(t), e & Se && this.maybeExportDefined(r, t);
      else if (e & yr)
        for (let i = this.scopeStack.length - 1; i >= 0 && (r = this.scopeStack[i], this.checkRedeclarationInScope(r, t, e, s), r.var.add(t), this.maybeExportDefined(r, t), !(r.flags & ft)); --i)
          ;
      this.parser.inModule && r.flags & $e && this.undefinedExports.delete(t);
    }
    maybeExportDefined(t, e) {
      this.parser.inModule && t.flags & $e && this.undefinedExports.delete(e);
    }
    checkRedeclarationInScope(t, e, s, r) {
      this.isRedeclaredInScope(t, e, s) && this.parser.raise(l.VarRedeclaration, { at: r, identifierName: e });
    }
    isRedeclaredInScope(t, e, s) {
      return s & Pe ? s & Se ? t.lexical.has(e) || t.functions.has(e) || t.var.has(e) : s & dt ? t.lexical.has(e) || !this.treatFunctionsAsVarInScope(t) && t.var.has(e) : t.lexical.has(e) && !(t.flags & dr && t.lexical.values().next().value === e) || !this.treatFunctionsAsVarInScope(t) && t.functions.has(e) : false;
    }
    checkLocalExport(t) {
    ...
    exit() {
      ...
      for (let [s, r] of Array.from(t.undefinedPrivateNames))
        e ? e.undefinedPrivateNames.has(s) || e.undefinedPrivateNames.set(s, r) : this.parser.raise(l.InvalidPrivateFieldResolution, { at: r, identifierName: s });
    }
    declarePrivateName(t, e, s) {
      ...
      if (e & ss) {
        let o = n && i.get(t);
        if (o) {
          let c = o & xt, f = e & xt, y = o & ss, T = e & ss;
          n = y === T || c !== f, n || i.delete(t);
        } else
          n || i.set(t, e);
      }
      n && this.parser.raise(l.PrivateNameRedeclaration, { at: s, identifierName: t }), r.add(t), a.delete(t);
    }
    usePrivateName(t, e) {
      let s;
      for (s of this.stack)
        if (s.privateNames.has(t))
          return;
      s ? s.undefinedPrivateNames.set(t, e) : this.parser.raise(l.InvalidPrivateFieldResolution, { at: e, identifierName: t });
    }
  }, ih = 0, Sr = 1, hs = 2, wr = 3, Pt = class {
    constructor() {
    ...
    recordAsyncArrowParametersError(t) {
      ...
      for (; i.canBeArrowParameterDeclaration(); )
        i.type === hs && i.recordDeclarationError(l.AwaitBindingIdentifier, { at: e }), i = s[--r];
    }
    validateAsPattern() {
  ...
  var He = 0, kr = 1, Tt = 2, Dr = 4, We = 8, lh = class {
    constructor() {
      this.stacks = [];
    }
    enter(t) {
  ...
  var uh = class extends Zo {
    ...
    checkExpressionErrors(t, e) {
      ...
      if (!e)
        return n;
      s != null && this.raise(l.InvalidCoverInitializedName, { at: s }), r != null && this.raise(l.DuplicateProto, { at: r }), i != null && this.raise(l.UnexpectedPrivateField, { at: i }), a != null && this.unexpected(a);
    }
    ...
    enterInitialScopes() {
      let t = He;
      this.inModule && (t |= Tt), this.scope.enter($e), this.prodParam.enter(t);
    }
  ...
  ls.__clone = function() {
    let t = new Ct(), e = Object.keys(this);
  ...
  var gh = /\*?\s*@((?:no)?flow)\b/, Ah = (t) => class extends t {
    ...
    flowParseDeclareFunction(e) {
      ...
      return r.params = a.params, r.rest = a.rest, r.this = a._this, this.expect(11), [r.returnType, e.predicate] = this.flowParseTypeAndPredicateInitialiser(), i.typeAnnotation = this.finishNode(r, "FunctionTypeAnnotation"), s.typeAnnotation = this.finishNode(i, "TypeAnnotation"), this.resetEndLocation(s), this.semicolon(), this.scope.declareName(e.id.name, qo, e.id.loc.start), this.finishNode(e, "DeclareFunction");
    }
    ...
    flowParseDeclareVariable(e) {
      return this.next(), e.id = this.flowParseTypeAnnotatableIdentifier(true), this.scope.declareName(e.id.name, yt, e.id.loc.start), this.semicolon(), this.finishNode(e, "DeclareVariable");
    }
    flowParseDeclareModule(e) {
      this.scope.enter(Ke), this.match(129) ? e.id = this.parseExprAtom() : e.id = this.parseIdentifier();
      ...
      let i = null, a = false;
      return r.forEach((n) => {
        mh(n) ? (i === "CommonJS" && this.raise(I.AmbiguousDeclareModuleKind, { at: n }), i = "ES") : n.type === "DeclareModuleExports" && (a && this.raise(I.DuplicateDeclareModuleExports, { at: n }), i === "ES" && this.raise(I.AmbiguousDeclareModuleKind, { at: n }), i = "CommonJS", a = true);
    ...
    flowParseDeclareExportDeclaration(e, s) {
      ...
      if (this.match(75) || this.isLet() || (this.isContextual(126) || this.isContextual(125)) && !s) {
        ...
        throw this.raise(I.UnsupportedDeclareExportKind, { at: this.state.startLoc, unsupportedExportKind: r, suggestion: yh[r] });
      }
    ...
    flowParseInterfaceish(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      if (e.id = this.flowParseRestrictedIdentifier(!s, true), this.scope.declareName(e.id.name, s ? Ar : Te, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], e.implements = [], e.mixins = [], this.eat(81))
        do
    ...
    checkReservedType(e, s, r) {
      !dh.has(e) || this.raise(r ? I.AssignReservedType : I.UnexpectedReservedType, { at: s, reservedType: e });
    }
    ...
    flowParseTypeAlias(e) {
      return e.id = this.flowParseRestrictedIdentifier(false, true), this.scope.declareName(e.id.name, Te, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.right = this.flowParseTypeInitialiser(29), this.semicolon(), this.finishNode(e, "TypeAlias");
    }
    flowParseOpaqueType(e, s) {
      return this.expectContextual(126), e.id = this.flowParseRestrictedIdentifier(true, true), this.scope.declareName(e.id.name, Te, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.supertype = null, this.match(14) && (e.supertype = this.flowParseTypeInitialiser(14)), e.impltype = null, s || (e.impltype = this.flowParseTypeInitialiser(29)), this.semicolon(), this.finishNode(e, "OpaqueType");
    }
    ...
    flowParseObjectType(e) {
      ...
      for (r && this.match(6) ? (this.expect(6), f = 9, y = true) : (this.expect(5), f = 8, y = false), c.exact = y; !this.match(f); ) {
        let N = false, R = null, z = null, te = this.startNode();
        if (a && this.isContextual(115)) {
          let pe = this.lookahead();
          pe.type !== 14 && pe.type !== 17 && (this.next(), R = this.state.startLoc, s = false);
        }
        ...
        if (this.eat(0))
          R != null && this.unexpected(R), this.eat(0) ? (he && this.unexpected(he.loc.start), c.internalSlots.push(this.flowParseObjectTypeInternalSlot(te, N))) : c.indexers.push(this.flowParseObjectTypeIndexer(te, N, he));
        else if (this.match(10) || this.match(47))
          R != null && this.unexpected(R), he && this.unexpected(he.loc.start), c.callProperties.push(this.flowParseObjectTypeCallProperty(te, N));
        else {
          let pe = "init";
          ...
          let st = this.flowParseObjectTypeProperty(te, N, R, he, pe, i, n != null ? n : !y);
          st === null ? (T = true, z = this.state.lastTokStartLoc) : c.properties.push(st);
        }
        this.flowObjectTypeSemicolon(), z && !this.match(8) && !this.match(9) && this.raise(I.UnexpectedExplicitInexactInObject, { at: z });
      }
    ...
    flowCheckGetterSetterParams(e) {
      ...
      e.value.this && this.raise(e.kind === "get" ? I.GetterMayNotHaveThisParam : I.SetterMayNotHaveThisParam, { at: e.value.this }), r !== s && this.raise(e.kind === "get" ? l.BadGetterArity : l.BadSetterArity, { at: e }), e.kind === "set" && e.value.rest && this.raise(l.BadSetterRestParameter, { at: e });
    }
    ...
    shouldParseExportDeclaration() {
      ...
      return or(e) || this.shouldParseEnums() && e === 122 ? !this.state.containsEsc : super.shouldParseExportDeclaration();
    }
    isExportDefaultSpecifier() {
      let { type: e } = this.state;
      return or(e) || this.shouldParseEnums() && e === 122 ? this.state.containsEsc : super.isExportDefaultSpecifier();
    }
    ...
    parseConditional(e, s, r, i) {
      ...
      this.expect(17);
      let a = this.state.clone(), n = this.state.noArrowAt, o = this.startNodeAt(s, r), { consequent: c, failed: f } = this.tryParseConditionalConsequent(), [y, T] = this.getArrowLikeExpressions(c);
      if (f || T.length > 0) {
        let v = [...n];
        if (T.length > 0) {
          ...
          for (let N = 0; N < T.length; N++)
            v.push(T[N].start);
          ({ consequent: c, failed: f } = this.tryParseConditionalConsequent()), [y, T] = this.getArrowLikeExpressions(c);
        }
    ...
    getArrowLikeExpressions(e, s) {
      ...
      return s ? (i.forEach((a) => this.finishArrowValidation(a)), [i, []]) : xh(i, (a) => a.params.every((n) => this.isAssignable(n, true)));
    }
    finishArrowValidation(e) {
      var s;
      this.toAssignableList(e.params, (s = e.extra) == null ? void 0 : s.trailingCommaLoc, false), this.scope.enter(Ae | Xt), super.checkParams(e, false, true), this.scope.exit();
    }
    ...
    readIterator() {
      ...
      (!this.isIterator(e) || !this.state.inType) && this.raise(l.InvalidIdentifier, { at: this.state.curPosition(), identifierName: s }), this.finishToken(128, s);
    }
    getTokenFromCode(e) {
      let s = this.input.charCodeAt(this.state.pos + 1);
      return e === 123 && s === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? s === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : Do(e, s, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
    }
    isAssignable(e, s) {
    ...
    shouldParseDefaultImport(e) {
      return us(e) ? Fr(this.state.type) : super.shouldParseDefaultImport(e);
    }
    ...
    maybeParseDefaultImportSpecifier(e) {
      ...
      if (this.match(87) ? s = "typeof" : this.isContextual(126) && (s = "type"), s) {
        ...
        s === "type" && i === 55 && this.unexpected(null, r.type), (Fr(i) || i === 5 || i === 55) && (this.next(), e.importKind = s);
      }
    ...
    parseImportSpecifier(e, s, r, i) {
      ...
      if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
        ...
        n !== null && !ye(this.state.type) ? (e.imported = f, e.importKind = n, e.local = Ee(f)) : (e.imported = a, e.importKind = null, e.local = this.parseIdentifier());
      } else {
        if (n !== null && ye(this.state.type))
          e.imported = this.parseIdentifier(true), e.importKind = n;
        else {
          if (s)
            throw this.raise(l.ImportBindingIsString, { at: e, importName: a.value });
    ...
    parseMaybeAssign(e, s) {
      ...
      if ((r = a) != null && r.error || this.match(47)) {
        ...
        let c, f = this.tryParse((T) => {
          ...
          return R.type !== "ArrowFunctionExpression" && T(), R.typeParameters = c, this.resetStartLocationFromNode(R, c), N;
        }, i), y = null;
    ...
    flowEnumMembers(e) {
      ...
      for (; !this.match(8); ) {
        ...
        switch (o.id = c, f.type) {
          case "boolean": {
            this.flowEnumCheckExplicitTypeMismatch(f.loc, T, "boolean"), o.init = f.value, a.booleanMembers.push(this.finishNode(o, "EnumBooleanMember"));
            break;
          }
          case "number": {
            this.flowEnumCheckExplicitTypeMismatch(f.loc, T, "number"), o.init = f.value, a.numberMembers.push(this.finishNode(o, "EnumNumberMember"));
            break;
          }
          case "string": {
            this.flowEnumCheckExplicitTypeMismatch(f.loc, T, "string"), o.init = f.value, a.stringMembers.push(this.finishNode(o, "EnumStringMember"));
            break;
          }
          case "invalid":
    ...
    flowEnumBody(e, s) {
      ...
      switch (e.hasUnknownMembers = o, a) {
        ...
        default: {
          ...
          let f = n.booleanMembers.length, y = n.numberMembers.length, T = n.stringMembers.length, v = n.defaultedMembers.length;
          if (!f && !y && !T && !v)
            return c();
          if (!f && !y)
    ...
    jsxReadToken() {
      ...
      for (; ; ) {
        ...
        switch (r) {
          ...
          case 125:
          default:
            Oe(r) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(true), s = this.state.pos) : ++this.state.pos;
        }
      }
    }
    jsxReadNewLine(e) {
...
`) : r = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, r;
    ...
    jsxReadString(e) {
      ...
      for (; ; ) {
        ...
        if (i === e)
          break;
        i === 38 ? (s += this.input.slice(r, this.state.pos), s += this.jsxReadEntity(), r = this.state.pos) : Oe(i) ? (s += this.input.slice(r, this.state.pos), s += this.jsxReadNewLine(false), r = this.state.pos) : ++this.state.pos;
      }
    ...
    jsxReadEntity() {
      ...
      if (this.codePointAtPos(this.state.pos) === 35) {
        ...
        for (; s++ < 10 && this.state.pos < this.length && !(r = this.codePointAtPos(this.state.pos) == 59); )
          ++this.state.pos;
        if (r) {
          let i = this.input.slice(e, this.state.pos), a = Ph[i];
          if (++this.state.pos, a)
            return a;
        }
      }
    ...
    jsxParseIdentifier() {
      let e = this.startNode();
      return this.match(136) ? e.name = this.state.value : Vt(this.state.type) ? e.name = ve(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
    }
    ...
    jsxParseElementAt(e, s) {
      ...
      if (!a.selfClosing) {
        ...
        Ne(a) && !Ne(n) && n !== null ? this.raise(Be.MissingClosingTagFragment, { at: n }) : !Ne(a) && Ne(n) ? this.raise(Be.MissingClosingTagElement, { at: n, openingTagName: Ge(a.name) }) : !Ne(a) && !Ne(n) && Ge(n.name) !== Ge(a.name) && this.raise(Be.MissingClosingTagElement, { at: n, openingTagName: Ge(a.name) });
      }
      if (Ne(a) ? (r.openingFragment = a, r.closingFragment = n) : (r.openingElement = a, r.closingElement = n), r.children = i, this.match(47))
        throw this.raise(Be.UnwrappedAdjacentJSXElements, { at: this.state.startLoc });
      return Ne(a) ? this.finishNode(r, "JSXFragment") : this.finishNode(r, "JSXElement");
    }
    jsxParseElement() {
    ...
    updateContext(e) {
      ...
      if (r === 56 && e === 138)
        ...
        let i = s[s.length - 1];
        i === U.j_oTag && e === 56 || i === U.j_cTag ? (s.pop(), this.state.canStartJSXElement = s[s.length - 1] === U.j_expr) : (this.setContext(U.j_expr), this.state.canStartJSXElement = true);
      } else
        this.state.canStartJSXElement = fo(r);
    }
  }, Eh = class extends ns {
    constructor() {
    ...
    declareName(t, e, s) {
      ...
      super.declareName(...arguments), e & Ve && (e & Pe || (this.checkRedeclarationInScope(r, t, e, s), this.maybeExportDefined(r, t)), r.types.add(t)), e & Yt && r.enums.add(t), e & $t && r.constEnums.add(t), e & mt && r.classes.add(t);
    }
    isRedeclaredInScope(t, e, s) {
      if (t.enums.has(e)) {
        if (s & Yt) {
      ...
      return s & mt && t.classes.has(e) ? t.lexical.has(e) ? !!(s & Pe) : false : s & Ve && t.types.has(e) ? true : super.isRedeclaredInScope(...arguments);
    }
    checkLocalExport(t) {
  ...
  var S = j(Un || (Un = ht(["typescript"])))((t) => ({ AbstractMethodHasImplementation: t((e) => {
    let { methodName: s } = e;
  ...
  var Ih = (t) => class extends t {
    ...
    tsParseModifiers(e) {
      let { modified: s, allowedModifiers: r, disallowedModifiers: i, stopOnStartOfClassStaticBlock: a, errorTemplate: n = S.InvalidModifierOnTypeMember } = e, o = (f, y, T, v) => {
        y === T && s[v] && this.raise(S.InvalidModifiersOrder, { at: f, orderedModifiers: [T, v] });
      }, c = (f, y, T, v) => {
        (s[T] && y === v || s[v] && y === T) && this.raise(S.IncompatibleModifiers, { at: f, modifiers: [T, v] });
      };
      for (; ; ) {
        let { startLoc: f } = this.state, y = this.tsParseModifier(r.concat(i != null ? i : []), a);
        if (!y)
          break;
        Or(y) ? s.accessibility ? this.raise(S.DuplicateAccessibilityModifier, { at: f, modifier: y }) : (o(f, y, y, "override"), o(f, y, y, "static"), o(f, y, y, "readonly"), s.accessibility = y) : Nh(y) ? (s[y] && this.raise(S.DuplicateModifier, { at: f, modifier: y }), s[y] = true, o(f, y, "in", "out")) : (Object.hasOwnProperty.call(s, y) ? this.raise(S.DuplicateModifier, { at: f, modifier: y }) : (o(f, y, "static", "readonly"), o(f, y, "static", "override"), o(f, y, "override", "readonly"), o(f, y, "abstract", "override"), c(f, y, "declare", "override"), c(f, y, "static", "abstract")), s[y] = true), i != null && i.includes(y) && this.raise(n, { at: f, modifier: y });
      }
    }
    ...
    tsParseDelimitedList(e, s, r) {
      return vh(this.tsParseDelimitedListWorker(e, s, true, r));
    }
    ...
    tsParsePropertyOrMethodSignature(e, s) {
      ...
      if (this.match(10) || this.match(47)) {
        ...
        if (i.kind === "get")
          i[a].length > 0 && (this.raise(l.BadGetterArity, { at: this.state.curPosition() }), this.isThisParam(i[a][0]) && this.raise(S.AccesorCannotDeclareThisParameter, { at: this.state.curPosition() }));
        else if (i.kind === "set") {
          if (i[a].length !== 1)
    ...
    tsParseNonArrayType() {
      switch (this.state.type) {
        ...
        default: {
          let { type: e } = this.state;
          if (K(e) || e === 88 || e === 84) {
            let s = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : wh(this.state.value);
    ...
    tsParseTypeOperatorOrHigher() {
      return Po(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(112) ? this.tsParseInferType() : this.tsInAllowConditionalTypesContext(() => this.tsParseArrayTypeOrHigher());
    }
    ...
    tsParseInterfaceDeclaration(e) {
      ...
      if (this.hasFollowingLineBreak())
        return null;
      this.expectContextual(125), s.declare && (e.declare = true), K(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Oo)) : (e.id = null, this.raise(S.MissingInterfaceName, { at: this.state.startLoc })), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutModifiers.bind(this)), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
      let r = this.startNode();
    ...
    tsParseTypeAliasDeclaration(e) {
      return e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Bo), e.typeAnnotation = this.tsInType(() => {
    ...
    tsParseEnumDeclaration(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      return s.const && (e.const = true), s.declare && (e.declare = true), this.expectContextual(122), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? Ro : Pr), this.expect(5), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(8), this.finishNode(e, "TSEnumDeclaration");
    }
    tsParseModuleBlock() {
      let e = this.startNode();
      return this.scope.enter(Ke), this.expect(5), this.parseBlockOrModuleBlockBody(e.body = [], void 0, true, 8), this.scope.exit(), this.finishNode(e, "TSModuleBlock");
    }
    tsParseModuleOrNamespaceDeclaration(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      if (e.id = this.parseIdentifier(), s || this.checkIdentifier(e.id, jo), this.eat(16)) {
        let r = this.startNode();
        this.tsParseModuleOrNamespaceDeclaration(r, true), e.body = r;
      } else
        this.scope.enter(pt), this.prodParam.enter(He), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit();
      return this.finishNode(e, "TSModuleDeclaration");
    }
    tsParseAmbientExternalModuleDeclaration(e) {
      return this.isContextual(109) ? (e.global = true, e.id = this.parseIdentifier()) : this.match(129) ? e.id = this.parseExprAtom() : this.unexpected(), this.match(5) ? (this.scope.enter(pt), this.prodParam.enter(He), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit()) : this.semicolon(), this.finishNode(e, "TSModuleDeclaration");
    }
    tsParseImportEqualsDeclaration(e, s) {
      e.isExport = s || false, e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Te), this.expect(29);
    ...
    registerFunctionStatementId(e) {
      !e.body && e.id ? this.checkIdentifier(e.id, Tr) : super.registerFunctionStatementId(...arguments);
    }
      ...
      if (this.match(47) || this.match(51)) {
        let o, c = this.tsTryParseAndCatch(() => {
          ...
          if (!i && this.eat(10)) {
            ...
            return T.callee = e, T.arguments = this.parseCallExpressionArguments(11, false), this.tsCheckForInvalidTypeCasts(T.arguments), T.typeParameters = f, a.optionalChainMember && (T.optional = n), this.finishCallExpression(T, a.optionalChainMember);
          }
    ...
    parseExprOp(e, s, r, i) {
      if (lt(58) > i && !this.hasPrecedingLineBreak() && this.isContextual(93)) {
        let a = this.startNodeAt(s, r);
        a.expression = e;
    ...
    parseMaybeAssign() {
      ...
      let T, v, N;
      if (this.hasPlugin("jsx") && (this.match(138) || this.match(47))) {
        if (T = this.state.clone(), v = this.tryParse(() => super.parseMaybeAssign(...s), T), !v.error)
          return v.node;
        let { context: te } = this.state, he = te[te.length - 1];
      ...
      let z = this.tryParse((te) => {
        ...
        return (de.type !== "ArrowFunctionExpression" || (he = de.extra) != null && he.parenthesized) && te(), ((pe = R) == null ? void 0 : pe.params.length) !== 0 && this.resetStartLocationFromNode(de, R), de.typeParameters = R, this.hasPlugin("jsx") && de.typeParameters.params.length === 1 && !((st = de.typeParameters.extra) != null && st.trailingComma) && de.typeParameters.params[0].constraint, de;
      }, T);
      if (!z.error && !z.aborted)
        return R && this.reportReservedArrowTypeParam(R), z.node;
      if (!v && (Lr(!this.hasPlugin("jsx")), N = this.tryParse(() => super.parseMaybeAssign(...s), T), !N.error))
        return N.node;
      if ((a = v) != null && a.node)
    ...
    isValidLVal(e, s, r) {
      return Ch({ TSTypeCastExpression: true, TSParameterProperty: "parameter", TSNonNullExpression: "expression", TSAsExpression: (r !== Le || !s) && ["expression", true], TSTypeAssertion: (r !== Le || !s) && ["expression", true] }, e) || super.isValidLVal(e, s, r);
    }
    parseBindingAtom() {
      switch (this.state.type) {
        case 78:
    ...
    parseTypeOnlyImportExportSpecifier(e, s, r) {
      ...
      if (this.isContextual(93)) {
        ...
        if (this.isContextual(93)) {
          ...
          ye(this.state.type) ? (c = true, n = v, o = s ? this.parseIdentifier() : this.parseModuleExportName(), f = false) : (o = N, f = false);
        } else
          ye(this.state.type) ? (f = false, o = s ? this.parseIdentifier() : this.parseModuleExportName()) : (c = true, n = v);
      } else
        ye(this.state.type) && (c = true, s ? (n = this.parseIdentifier(true), this.isContextual(93) || this.checkReservedWord(n.name, n.loc.start, true, true)) : n = this.parseModuleExportName());
      ...
      e[T] = c ? "type" : "value", f && this.eatContextual(93) && (e[a] = s ? this.parseIdentifier() : this.parseModuleExportName()), e[a] || (e[a] = Ee(e[i])), s && this.checkIdentifier(e[a], Te);
    }
  };
  function kh(t) {
    ...
    return e && s.type !== "StringLiteral" && (s.type !== "TemplateLiteral" || s.expressions.length > 0) ? false : Br(t.object);
  }
  function Br(t) {
    return t.type === "Identifier" ? true : t.type !== "MemberExpression" || t.computed ? false : Br(t.object);
  }
  var Mr = j(_n || (_n = ht(["placeholders"])))((t) => ({ ClassNameIsRequired: t("A class name is required."), UnexpectedSpace: t("Unexpected space in placeholder.") })), Dh = (t) => class extends t {
    parsePlaceholder(e) {
      if (this.match(140)) {
        let s = this.startNode();
    ...
    parseClass(e, s, r) {
      ...
      if (n)
        if (this.match(81) || this.match(140) || this.match(5))
          ...
          throw this.raise(Mr.ClassNameIsRequired, { at: this.state.startLoc });
        }
      else
    ...
    assertNoSpace() {
      this.state.start > this.state.lastTokEndLoc.index && this.raise(Mr.UnexpectedSpace, { at: this.state.lastTokEndLoc });
    }
  ...
  var Rr = ["minimal", "fsharp", "hack", "smart"], jr = ["^^", "@@", "^", "%", "#"], qr = ["hash", "bar"];
  function Lh(t) {
    if (se(t, "decorators")) {
    ...
    if (se(t, "recordAndTuple") && !qr.includes(et(t, "recordAndTuple", "syntaxType")))
      throw new Error("'recordAndTuple' requires 'syntaxType' option whose value should be one of: " + qr.map((e) => "'".concat(e, "'")).join(", "));
  ...
  var Mh = (t, e) => Object.hasOwnProperty.call(t, e) && t[e], zr = (t) => t.type === "ParenthesizedExpression" ? zr(t.expression) : t, Rh = class extends fh {
      ...
      switch ((t.type === "ParenthesizedExpression" || (s = t.extra) != null && s.parenthesized) && (i = zr(t), e ? i.type === "Identifier" ? this.expressionScope.recordArrowParemeterBindingError(l.InvalidParenthesizedAssignment, { at: t }) : i.type !== "MemberExpression" && this.raise(l.InvalidParenthesizedAssignment, { at: t }) : this.raise(l.InvalidParenthesizedAssignment, { at: t })), t.type) {
        ...
        case "ObjectExpression":
          ...
          for (let n = 0, o = t.properties.length, c = o - 1; n < o; n++) {
            ...
            this.toAssignableObjectExpressionProp(f, y, e), y && f.type === "RestElement" && (a = t.extra) != null && a.trailingCommaLoc && this.raise(l.RestTrailingComma, { at: t.extra.trailingCommaLoc });
          }
          break;
        case "ObjectProperty": {
          let { key: n, value: o } = t;
    ...
    toAssignableObjectExpressionProp(t, e, s) {
      if (t.type === "ObjectMethod")
        ...
        t.type = "RestElement";
        let r = t.argument;
        this.checkToRestConversion(r, false), this.toAssignable(r, s), e || this.raise(l.RestTrailingComma, { at: t });
      } else
    ...
    toAssignableList(t, e, s) {
      ...
      for (let i = 0; i <= r; i++) {
        ...
        if (!!a) {
          ...
          a.type === "RestElement" && (i < r ? this.raise(l.RestTrailingComma, { at: a }) : e && this.raise(l.RestTrailingComma, { at: e }));
        }
      }
    }
    isAssignable(t, e) {
    ...
    checkLVal(t, e) {
      let { in: s, binding: r = Le, checkClashes: i = false, strictModeChanged: a = false, allowingSloppyLetBinding: n = !(r & Se), hasParenthesizedAncestor: o = false } = e;
      var c;
      let f = t.type;
      if (this.isObjectMethod(t))
        return;
      if (f === "MemberExpression") {
        r !== Le && this.raise(l.InvalidPropertyBindingPattern, { at: t });
        return;
      }
      ...
      if (y === false) {
        ...
        this.raise(R, { at: t, ancestor: s.type === "UpdateExpression" ? { type: "UpdateExpression", prefix: s.prefix } : { type: s.type } });
        return;
      }
      let [T, v] = Array.isArray(y) ? y : [y, f === "ParenthesizedExpression"], N = t.type === "ArrayPattern" || t.type === "ObjectPattern" || t.type === "ParenthesizedExpression" ? t : s;
      for (let R of [].concat(t[T]))
        R && this.checkLVal(R, { in: N, binding: r, checkClashes: i, allowingSloppyLetBinding: n, strictModeChanged: a, hasParenthesizedAncestor: v });
    }
    checkIdentifier(t, e) {
      let s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !(e & Se);
      this.state.strict && (s ? fr(t.name, this.inModule) : pr(t.name)) && (e === Le ? this.raise(l.StrictEvalArguments, { at: t, referenceName: t.name }) : this.raise(l.StrictEvalArgumentsBinding, { at: t, bindingName: t.name })), !r && t.name === "let" && this.raise(l.LetInLexicalBinding, { at: t }), e & Le || this.declareNameFromIdentifier(t, e);
    }
    ...
    checkProto(t, e, s, r) {
      ...
      if ((i.type === "Identifier" ? i.name : i.value) === "__proto__") {
        ...
        s.used && (r ? r.doubleProtoLoc === null && (r.doubleProtoLoc = i.loc.start) : this.raise(l.DuplicateProto, { at: i })), s.used = true;
      }
    }
    ...
    parseExprOp(t, e, s, r) {
      if (this.isPrivateName(t)) {
        ...
        (r >= lt(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(l.PrivateInExpectedIn, { at: t, identifierName: a }), this.classScope.usePrivateName(a, t.loc.start);
      }
      ...
      if (xo(i) && (this.prodParam.hasIn || !this.match(58))) {
        ...
        if (a > r) {
          ...
          if (c && (a = lt(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
    ...
    parseHackPipeBody() {
      ...
      return L.has(s.type) && !((t = s.extra) != null && t.parenthesized) && this.raise(l.PipeUnparenthesizedBody, { at: e, type: s.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(l.PipeTopicUnused, { at: e }), s;
    }
    ...
    parseMaybeUnary(t, e) {
      ...
      if (i) {
        ...
        if ((this.hasPlugin("v8intrinsic") ? Kt(c) : Kt(c) && !this.match(54)) && !this.isAmbiguousAwait())
          return this.raiseOverwrite(l.AwaitNotInAsyncContext, { at: r }), this.parseAwait(s, r);
      }
      return o;
    }
    parseUpdate(t, e, s) {
    ...
    parseTaggedTemplateExpression(t, e, s, r) {
      let i = this.startNodeAt(e, s);
      return i.tag = t, i.quasi = this.parseTemplate(true), r.optionalChainMember && this.raise(l.OptionalChainingNoTemplate, { at: s }), this.finishNode(i, "TaggedTemplateExpression");
    }
      ...
      if (t.callee.type === "Import")
        if (t.arguments.length === 2 && (this.hasPlugin("moduleAttributes") || this.expectPlugin("importAssertions")), t.arguments.length === 0 || t.arguments.length > 2)
          ...
          for (let s of t.arguments)
            s.type === "SpreadElement" && this.raise(l.ImportCallSpreadArgument, { at: s });
    ...
    parseAsyncArrowFromCallExpression(t, e) {
      var s;
      return this.resetPreviousNodeTrailingComments(e), this.expect(19), this.parseArrowExpression(t, e.arguments, true, (s = e.extra) == null ? void 0 : s.trailingCommaLoc), e.innerComments && Qe(t, e.innerComments), e.callee.trailingComments && Qe(t, e.callee.trailingComments), t;
    }
    parseNoCallExpr() {
    ...
    finishTopicReference(t, e, s, r) {
      if (this.testTopicReferenceConfiguration(s, e, r)) {
        ...
        return this.topicReferenceIsAllowedInCurrentContext() || this.raise(s === "smart" ? l.PrimaryTopicNotAllowed : l.PipeTopicUnbound, { at: e }), this.registerTopicReference(), this.finishNode(t, i);
      } else
        throw this.raise(l.PipeTopicUnconfiguredToken, { at: e, token: ve(r) });
    }
    ...
    parseDo(t, e) {
      ...
      return this.state.labels = [], e ? (this.prodParam.enter(Tt), t.body = this.parseBlock(), this.prodParam.exit()) : t.body = this.parseBlock(), this.state.labels = s, this.finishNode(t, "DoExpression");
    }
    parseSuper() {
      let t = this.startNode();
    ...
    parseMetaProperty(t, e, s) {
      ...
      return t.property = this.parseIdentifier(true), (t.property.name !== s || r) && this.raise(l.UnsupportedMetaProperty, { at: t.property, target: e.name, onlyValidPropertyName: s }), this.finishNode(t, "MetaProperty");
    }
    ...
    parseParenAndDistinguishExpression(t) {
      ...
      let n = this.state.start, o = this.state.startLoc, c = [], f = new bt(), y = true, T, v;
      for (; !this.match(11); ) {
        if (y)
          y = false;
        ...
        if (this.match(21)) {
          let z = this.state.start, te = this.state.startLoc;
          if (T = this.state.startLoc, c.push(this.parseParenItem(this.parseRestBinding(), z, te)), !this.checkCommaAfterRest(41))
            break;
        } else
    ...
    parseNewOrNewTarget() {
      ...
      if (this.next(), this.match(16)) {
        ...
        return !this.scope.inNonArrowFunction && !this.scope.inClass && this.raise(l.UnexpectedNewTarget, { at: s }), s;
      }
    ...
    parseTemplateElement(t) {
      ...
      i === null && (t || this.raise(l.InvalidEscapeSequenceTemplate, { at: m(s, 2) }));
...
`), cooked: i === null ? null : i.slice(1, c) }, n.tail = o, this.next(), this.finishNode(n, "TemplateElement"), this.resetEndLocation(n, m(this.state.lastTokEndLoc, c)), n;
    ...
    parseObjectLike(t, e, s, r) {
      ...
      for (o.properties = [], this.next(); !this.match(t); ) {
        ...
        let f;
        e ? f = this.parseBindingProperty() : (f = this.parsePropertyDefinition(r), this.checkProto(f, s, a, r)), s && !this.isObjectProperty(f) && f.type !== "SpreadElement" && this.raise(l.InvalidRecordProperty, { at: f }), f.shorthand && this.addExtra(f, "shorthand", true), o.properties.push(f);
      }
    ...
    parsePropertyDefinition(t) {
      ...
      if (!o && !c && this.maybeAsyncOrAccessorProp(s)) {
        let y = f.name;
        y === "async" && !this.hasPrecedingLineBreak() && (r = true, this.resetPreviousNodeTrailingComments(f), o = this.eat(55), this.parsePropertyName(s)), (y === "get" || y === "set") && (i = true, this.resetPreviousNodeTrailingComments(f), s.kind = y, this.match(55) && (o = true, this.raise(l.AccessorIsGenerator, { at: this.state.curPosition(), kind: y }), this.next()), this.parsePropertyName(s));
      }
    ...
    checkGetterSetterParams(t) {
      ...
      r.length !== s && this.raise(t.kind === "get" ? l.BadGetterArity : l.BadSetterArity, { at: t }), t.kind === "set" && ((e = r[r.length - 1]) == null ? void 0 : e.type) === "RestElement" && this.raise(l.BadSetterRestParameter, { at: t });
    }
    ...
    parseObjectProperty(t, e, s, r, i) {
      ...
      if (!t.computed && t.key.type === "Identifier") {
        if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), r)
          ...
          i != null ? i.shorthandAssignLoc === null && (i.shorthandAssignLoc = a) : this.raise(l.InvalidCoverInitializedName, { at: a }), t.value = this.parseMaybeDefault(e, s, Ee(t.key));
        } else
          t.value = Ee(t.key);
      ...
      if (this.eat(0))
        ...
        if (ye(s))
          ...
          switch (s) {
            ...
            case 134: {
              let a = this.state.startLoc;
              e != null ? e.privateKeyLoc === null && (e.privateKeyLoc = a) : this.raise(l.UnexpectedPrivateField, { at: a }), i = this.parsePrivateName();
              break;
            }
            default:
              throw this.unexpected();
    ...
    parseMethod(t, e, s, r, i, a) {
      ...
      let o = r;
      return this.scope.enter(Ae | ct | (n ? Fe : 0) | (i ? mr : 0)), this.prodParam.enter(Et(s, t.generator)), this.parseFunctionParams(t, o), this.parseFunctionBodyAndFinish(t, a, true), this.prodParam.exit(), this.scope.exit(), t;
    }
    ...
    parseArrowExpression(t, e, s, r) {
      ...
      let i = Et(s, false);
      !this.match(5) && this.prodParam.hasIn && (i |= We), this.prodParam.enter(i), this.initFunction(t, s);
    ...
    parseFunctionBody(t, e) {
      ...
      if (this.expressionScope.enter(Ir()), r)
        ...
        this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | Dr), t.body = this.parseBlock(true, false, (n) => {
          ...
          this.checkParams(t, !this.state.strict && !e && !s && !o, e, c), this.state.strict && t.id && this.checkIdentifier(t.id, Mo, c);
    ...
    checkParams(t, e, s) {
      ...
      for (let n of t.params)
        this.checkLVal(n, { in: a, binding: yt, checkClashes: i, strictModeChanged: r });
    }
    ...
    parseExprListItem(t, e, s) {
      ...
      if (this.match(12))
        ...
        this.expectPlugin("partialApplication"), s || this.raise(l.UnexpectedArgumentPlaceholder, { at: this.state.startLoc });
        let i = this.startNode();
    ...
    checkReservedWord(t, e, s, r) {
      ...
      (this.state.strict ? r ? fr : cr : ur)(t, this.inModule) && this.raise(l.UnexpectedReservedWord, { at: e, reservedWord: t });
    }
    isAwaitAllowed() {
    ...
    parseAwait(t, e) {
      ...
      return this.expressionScope.recordParameterInitializerError(l.AwaitExpressionFormalParameter, { at: s }), this.eat(55) && this.raise(l.ObsoleteAwaitStar, { at: s }), !this.scope.inFunction && !this.options.allowAwaitOutsideFunction && (this.isAmbiguousAwait() ? this.ambiguousScriptDifferentAst = true : this.sawUnambiguousESM = true), this.state.soloAwait || (s.argument = this.parseMaybeUnary(null, true)), this.finishNode(s, "AwaitExpression");
    }
    isAmbiguousAwait() {
      if (this.hasPrecedingLineBreak())
        return true;
      let { type: t } = this.state;
      return t === 53 || t === 10 || t === 0 || ut(t) || t === 133 || t === 56 || this.hasPlugin("v8intrinsic") && t === 54;
    }
    parseYield() {
      let t = this.startNode();
  ...
  }, cs = { kind: "loop" }, qh = { kind: "switch" }, Uh = 0, ps = 1, Kr = 2, Vr = 4, _h = /[\uD800-\uDFFF]/u, fs = /in(?:stanceof)?/y;
  function zh(t, e) {
      ...
      if (typeof i == "number") {
        {
          if (i === 134) {
            ...
            t.splice(s, 1, new we({ type: xe(27), value: "#", start: n, end: f, startLoc: a.start, endLoc: y }), new we({ type: xe(128), value: o, start: f, end: c, startLoc: y, endLoc: a.end })), s++;
            continue;
          }
          if (ut(i)) {
            let { loc: a, start: n, value: o, end: c } = r, f = n + 1, y = m(a.start, 1), T;
            e.charCodeAt(n) === 96 ? T = new we({ type: xe(22), value: "`", start: n, end: f, startLoc: a.start, endLoc: y }) : T = new we({ type: xe(8), value: "}", start: n, end: f, startLoc: a.start, endLoc: y });
            let v, N, R, z;
            i === 24 ? (N = c - 1, R = m(a.end, -1), v = o === null ? null : o.slice(1, -1), z = new we({ type: xe(22), value: "`", start: N, end: c, startLoc: R, endLoc: a.end })) : (N = c - 2, R = m(a.end, -2), v = o === null ? null : o.slice(1, -2), z = new we({ type: xe(23), value: "${", start: N, end: c, startLoc: R, endLoc: a.end })), t.splice(s, 1, T, new we({ type: xe(20), value: v, start: f, end: N, startLoc: y, endLoc: R }), z), s += 2;
            continue;
          }
        }
        r.type = xe(i);
  ...
  var Kh = class extends jh {
    ...
    parseStatementContent(t, e) {
      ...
      switch (this.isLet(t) && (s = 74, i = "let"), s) {
        ...
        case 75:
        case 74:
          return i = i || this.state.value, t && i !== "var" && this.raise(l.UnexpectedLexicalDeclaration, { at: this.state.startLoc }), this.parseVarStatement(r, i);
        case 92:
    ...
    parseDoStatement(t) {
      return this.next(), this.state.labels.push(cs), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement("do")), this.state.labels.pop(), this.expect(92), t.test = this.parseHeaderExpression(), this.eat(13), this.finishNode(t, "DoWhileStatement");
    }
    parseForStatement(t) {
      this.next(), this.state.labels.push(cs);
      let e = null;
      if (this.isAwaitAllowed() && this.eatContextual(96) && (e = this.state.lastTokStartLoc), this.scope.enter(Ke), this.expect(10), this.match(13))
      ...
      let i = this.isContextual(95), a = new bt(), n = this.parseExpression(true, a), o = this.isContextual(101);
      if (o && (s && this.raise(l.ForOfLet, { at: n }), e === null && i && n.type === "Identifier" && this.raise(l.ForOfAsync, { at: n })), o || this.match(58)) {
    ...
    parseSwitchStatement(t) {
      ...
      for (let r; !this.match(8); )
        if (this.match(61) || this.match(65)) {
          let i = this.match(61);
          s && this.finishNode(s, "SwitchCase"), e.push(s = this.startNode()), s.consequent = [], this.next(), i ? s.test = this.parseExpression() : (r && this.raise(l.MultipleDefaultsInSwitch, { at: this.state.lastTokStartLoc }), r = true, s.test = null), this.expect(14);
        } else
    ...
    parseCatchClauseParam() {
      ...
      return this.scope.enter(e ? dr : 0), this.checkLVal(t, { in: { type: "CatchClause" }, binding: Te, allowingSloppyLetBinding: true }), t;
    }
    parseTryStatement(t) {
      if (this.next(), t.block = this.parseBlock(), t.handler = null, this.match(62)) {
        let e = this.startNode();
        this.next(), this.match(10) ? (this.expect(10), e.param = this.parseCatchClauseParam(), this.expect(11)) : (e.param = null, this.scope.enter(Ke)), e.body = this.withSmartMixTopicForbiddingContext(() => this.parseBlock(false, false)), this.scope.exit(), t.handler = this.finishNode(e, "CatchClause");
      }
    ...
    parseWhileStatement(t) {
      return this.next(), t.test = this.parseHeaderExpression(), this.state.labels.push(cs), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement("while")), this.state.labels.pop(), this.finishNode(t, "WhileStatement");
    }
    ...
    parseLabeledStatement(t, e, s, r) {
      for (let a of this.state.labels)
        a.name === e && this.raise(l.LabelRedeclaration, { at: s, labelName: e });
      let i = yo(this.state.type) ? "loop" : this.match(71) ? "switch" : null;
    ...
    parseBlock() {
      ...
      return t && this.state.strictErrors.clear(), this.expect(5), e && this.scope.enter(Ke), this.parseBlockBody(r, t, false, 8, s), e && this.scope.exit(), this.finishNode(r, "BlockStatement");
    }
    isValidDirective(t) {
    ...
    parseVarId(t, e) {
      t.id = this.parseBindingAtom(), this.checkLVal(t.id, { in: { type: "VariableDeclarator" }, binding: e === "var" ? yt : Te });
    }
    parseFunction(t) {
      let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Uh, s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, r = e & ps, i = e & Kr, a = !!r && !(e & Vr);
      this.initFunction(t, s), this.match(55) && i && this.raise(l.GeneratorInSingleStatementContext, { at: this.state.startLoc }), t.generator = this.eat(55), r && (t.id = this.parseFunctionId(a));
      let n = this.state.maybeInArrowParameters;
      return this.state.maybeInArrowParameters = false, this.scope.enter(Ae), this.prodParam.enter(Et(s, t.generator)), r || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, false), this.withSmartMixTopicForbiddingContext(() => {
    ...
    registerFunctionStatementId(t) {
      !t.id || this.scope.declareName(t.id.name, this.state.strict || t.generator || t.async ? this.scope.treatFunctionsAsVar ? yt : Te : Ar, t.id.loc.start);
    }
    parseClass(t, e, s) {
    ...
    parseClassBody(t, e) {
      ...
      if (i.body = [], this.expect(5), this.withSmartMixTopicForbiddingContext(() => {
        for (; !this.match(8); ) {
          ...
          let a = this.startNode();
          r.length && (a.decorators = r, this.resetStartLocationFromNode(a, r[0]), r = []), this.parseClassMember(i, a, s), a.kind === "constructor" && a.decorators && a.decorators.length > 0 && this.raise(l.DecoratorConstructor, { at: a });
        }
    ...
    parseClassMemberWithIsStatic(t, e, s, r) {
      ...
      if (e.static = r, this.parsePropertyNamePrefixOperator(e), this.eat(55)) {
        ...
        this.isNonstaticConstructor(i) && this.raise(l.ConstructorIsGenerator, { at: i.key }), this.pushClassMethod(t, i, true, false, false, false);
        return;
      }
      let T = K(this.state.type) && !this.state.containsEsc, v = this.match(134), N = this.parseClassElementName(e), R = this.state.startLoc;
      if (this.parsePostMemberNameModifiers(y), this.isClassMethod()) {
        if (f.kind = "method", v) {
          this.pushClassPrivateMethod(t, a, false, false);
          return;
        }
        let z = this.isNonstaticConstructor(i), te = false;
        z && (i.kind = "constructor", s.hadConstructor && !this.hasPlugin("typescript") && this.raise(l.DuplicateConstructor, { at: N }), z && this.hasPlugin("typescript") && e.override && this.raise(l.OverrideOnConstructor, { at: N }), s.hadConstructor = true, te = s.hadSuperClass), this.pushClassMethod(t, i, false, false, z, te);
      } else if (this.isClassProperty())
        ...
        this.parseClassElementName(f), this.parsePostMemberNameModifiers(y), te ? this.pushClassPrivateMethod(t, a, z, true) : (this.isNonstaticConstructor(i) && this.raise(l.ConstructorIsAsync, { at: i.key }), this.pushClassMethod(t, i, z, true, false, false));
      } else if (T && (N.name === "get" || N.name === "set") && !(this.match(55) && this.isLineTerminator())) {
        this.resetPreviousNodeTrailingComments(N), f.kind = N.name;
        let z = this.match(134);
        this.parseClassElementName(i), z ? this.pushClassPrivateMethod(t, a, false, false) : (this.isNonstaticConstructor(i) && this.raise(l.ConstructorIsAccessor, { at: i.key }), this.pushClassMethod(t, i, false, false, false, false)), this.checkGetterSetterParams(i);
    ...
    parseClassElementName(t) {
      ...
      if ((e === 128 || e === 129) && t.static && s === "prototype" && this.raise(l.StaticPrototype, { at: this.state.startLoc }), e === 134) {
        s === "constructor" && this.raise(l.ConstructorClassPrivateField, { at: this.state.startLoc });
    ...
    parseClassStaticBlock(t, e) {
      ...
      let i = e.body = [];
      this.parseBlockOrModuleBlockBody(i, void 0, false, 8), this.prodParam.exit(), this.scope.exit(), this.state.labels = r, t.body.push(this.finishNode(e, "StaticBlock")), (s = e.decorators) != null && s.length && this.raise(l.DecoratorStaticBlock, { at: e });
    }
    ...
    pushClassAccessorProperty(t, e, s) {
      if (!s && !e.computed) {
        let i = e.key;
        (i.name === "constructor" || i.value === "constructor") && this.raise(l.ConstructorClassField, { at: i });
      }
    ...
    pushClassPrivateMethod(t, e, s, r) {
      ...
      t.body.push(i);
      let a = i.kind === "get" ? i.static ? Uo : zo : i.kind === "set" ? i.static ? _o : Ko : rs;
    ...
    parseInitializer(t) {
      this.scope.enter(Fe | ct), this.expressionScope.enter(Ir()), this.prodParam.enter(He), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
    }
    parseClassId(t, e, s) {
      let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : gr;
      if (K(this.state.type))
    ...
    parseExportDefaultExpression() {
      ...
      if (this.match(68) || e)
        return this.next(), e && this.next(), this.parseFunction(t, ps | Vr, e);
      if (this.match(80))
      ...
      if (e) {
        if (s) {
          if (this.checkDuplicateExports(t, "default"), this.hasPlugin("exportDefaultFrom")) {
            var i;
            let n = t.declaration;
            n.type === "Identifier" && n.name === "from" && n.end - n.start === 4 && !((i = n.extra) != null && i.parenthesized) && this.raise(l.ExportDefaultFromAsIdentifier, { at: n });
          }
    ...
    finishImportSpecifier(t, e) {
      return this.checkLVal(t.local, { in: t, binding: Te }), this.finishNode(t, e);
    }
    parseAssertEntries() {
      ...
      do {
        ...
        if (e.has(r) && this.raise(l.ModuleAttributesWithDuplicateKeys, { at: this.state.startLoc, key: r }), e.add(r), this.match(129) ? s.key = this.parseStringLiteral(r) : s.key = this.parseIdentifier(true), this.expect(14), !this.match(129))
    ...
    maybeParseModuleAttributes() {
      ...
      do {
        let s = this.startNode();
        if (s.key = this.parseIdentifier(true), s.key.name !== "type" && this.raise(l.ModuleAttributeDifferentFromType, { at: s.key }), e.has(s.key.name) && this.raise(l.ModuleAttributesWithDuplicateKeys, { at: s.key, key: s.key.name }), e.add(s.key.name), this.expect(14), !this.match(129))
          throw this.raise(l.ModuleAttributeInvalidValue, { at: this.state.startLoc });
        s.value = this.parseStringLiteral(this.state.value), this.finishNode(s, "ImportAttribute"), t.push(s);
      } while (this.eat(12));
      return t;
    ...
    parseImportSpecifier(t, e, s, r) {
      if (this.eatContextual(93))
        ...
        let { imported: i } = t;
        if (e)
          throw this.raise(l.ImportBindingIsString, { at: t, importName: i.value });
        this.checkReservedWord(i.name, t.loc.start, true, true), t.local || (t.local = Ee(i));
      }
  ...
  function tt(t, e) {
    let s = Hr;
    return t != null && t.plugins && (Lh(t.plugins), s = Jh(t.plugins)), new s(t, e);
  }
  var Wr = {};
  function Jh(t) {
    let e = Oh.filter((i) => se(t, i)), s = e.join("/"), r = Wr[s];
    if (!r) {
      r = Hr;
      for (let i of e)
        r = Ur[i](r);
...
var hf = W({ "src/language-js/parse/json.js"(h, u) {
  "use strict";
  H();
  var p = io(), d = ar(), m = no(), x = oo();
  function A() {
    let C = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { allowComments: M = true } = C;
    return function(k) {
      let { parseExpression: G } = uo(), Z;
      try {
        Z = G(k, { tokens: true, ranges: true });
      } catch (B) {
        throw x(B);
      }
      if (!M && p(Z.comments))
        throw g(Z.comments[0], "Comment");
      return E(Z), Z;
    };
  }
  function g(C, M) {
    ...
    return d("".concat(M, " is not allowed in JSON."), { start: L, end: k });
  }
  function E(C) {
    switch (C.type) {
      case "ArrayExpression":
        ...
        return;
      case "ObjectExpression":
        for (let M of C.properties)
          E(M);
        return;
      case "ObjectProperty":
        if (C.computed)
          throw g(C.key, "Computed key");
        if (C.shorthand)
          throw g(C.key, "Shorthand property");
      ...
      case "UnaryExpression": {
        ...
        if (L.type === "NumericLiteral" || L.type === "Identifier" && (L.name === "Infinity" || L.name === "NaN"))
          return;
        throw g(L, "Operator '".concat(M, "' before '").concat(L.type, "'"));
      }
      case "Identifier":
...
var lf = W({ "src/language-js/parse/babel.js"(h, u) {
  ...
  function G(V, $) {
    ...
    let ce = m(V, 0);
    return ce !== false && (V = V.slice(0, ce)), k.test(V);
  }
  function Z(V, $, me) {
    let ae = uo()[V]($, me), q = ae.errors.find((X) => !ee.has(X.reasonCode));
    if (q)
      throw q;
    return ae;
  }
  function B(V) {
    for (var $ = arguments.length, me = new Array($ > 1 ? $ - 1 : 0), ce = 1; ce < $; ce++)
      me[ce - 1] = arguments[ce];
    return function(ae, q) {
      let X = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      if ((X.parser === "babel" || X.parser === "__babel_estree") && G(ae, X))
        return X.parser = "babel-flow", l(ae, q, X);
      let re = me;
      X.__babelSourceType === "script" && (re = re.map((oe) => Object.assign(Object.assign({}, oe), {}, { sourceType: "script" }))), /#[[{]/.test(ae) && (re = re.map((oe) => L([D], oe)));
      let ne = /%[A-Z]/.test(ae);
      ae.includes("|>") ? re = (ne ? [...M, C] : M).flatMap((Je) => re.map((Ye) => L([Je], Ye))) : ne && (re = re.map((oe) => L([C], oe)));
      let { result: Ue, error: _e } = p(...re.map((oe) => () => Z(V, ae, oe)));
      if (!Ue)
        throw A(_e);
      return X.originalText = ae, g(Ue, X);
    };
  }
  var j = B("parse", L(["jsx", "flow"])), l = B("parse", L(["jsx", ["flow", { all: true, enums: true }]])), Y = B("parse", L(["jsx", "typescript"]), L(["typescript"])), ie = B("parse", L(["jsx", "flow", "estree"])), Q = B("parseExpression", L(["jsx"])), Ce = B("parseExpression", L(["typescript"])), ee = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), U = x(j), O = x(Y), P = x(Q), De = x(Ce);
  u.exports = { parsers: Object.assign(Object.assign({ babel: U, "babel-flow": x(l), "babel-ts": O }, E), {}, { __js_expression: P, __vue_expression: P, __vue_ts_expression: De, __vue_event_binding: U, __vue_ts_event_binding: O, __babel_estree: x(ie) }) };
} });
var Fd = lf();

// dep:prettier_esm_parser-babel
var prettier_esm_parser_babel_default = Fd;
export {
